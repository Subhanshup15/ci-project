...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/Geriatric_date'); ?>">
            ...
            <div class="col-sm-8" align="center">  
                   <h3 style="margin-top: 0px; margin-bottom: 0px;"><strong><?php echo $this->session->userdata('title') ?></strong></h3>
                    ...
                    <?php   
                        ...
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php echo "Geriatric Diseases - OPD Register"; ?></h3>
                 ...
                 <div class="row col-sm-12" style="padding-bottom: 10px;font-size: 14px;">
                  ...
                  <!--  <form  method="POST" action="<?php echo base_url('patients/checked_data'); ?>" >-->
                    ...
                    <button onclick="excel_all_customer_invistigation('<?php echo date('Y-m-d',strtotime($datefrom));?>','<?php echo date('Y-m-d',strtotime($dateto));?>','<?php echo $ipd;?>')" class="btn btn-primary btn-sm"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;F</button>
                    </div>-->
                </div>
                                ...
                                <?php if($ECG !='') {?><tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else { echo ""; } ?>">
			                       ...
			                       ->where('department_id', $patient->department_id) 
                                    ...
                                    if($ipd == 'ipd'){ echo $doctor_name->firstname;} else { echo date('Y-m-d',strtotime($patient->create_date));}?></td><?php } ?>
                                     ...
                                     <?php if($department_by =='dpt') {?> <td  style="padding:2px;"><?php echo '';  ?></td>  <?php }?> 
