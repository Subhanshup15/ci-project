...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/ot'); ?>">
...
<div class="form-group">
    ...
    <!--</select>-->
    <input type="text" name="section" class="form-control" id="section" placeholder="<?php echo display('end_date') ?>" value='ipd' readonly>
</div>
            ...
            <div class="col-sm-12" align="center">  
                  <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php echo $this->session->userdata('title') ?></h3>
                    ...
                    <?php   
                        ...
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php  echo "Operation Theater Register";?></h3>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" <?php  if($gob=='gob') { echo "style='font-size:10px;'";}?> style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    <thead>
                        <tr>
                            ...
                            <th  <?php  if($gob=='gob') { echo "style='width:1px;'";}?> rowspan="2"><?php echo "Address" ?></th>          
                           
                            <th style="width: 30px; text-align: center;" colspan=2 ><?php echo "OT" ?></th>
                            
                            <th style="width: 30px;" rowspan="2">Shastra Karma</th> 
                            <th style="width: 30px;" rowspan="2">Shalya Chikitstak</th>
                            <th style="width: 30px;" rowspan="2">Samohan Tadnya</th>
                            <th style="width: 30px;" rowspan="2">Samohan Prakar</th>
                            <th style="width: 30px;" rowspan="2">Signature</th>
                        ...
                        <tr>                
                            ...
                            <th style="width: 30px;" ><?php echo "Minar" ?></th>
                            <th style="width: 30px;" ><?php echo "Major" ?></th>
                            ...
                            //atya
                              ...
                              ?>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else if(($New_OPD ==$patient->yearly_reg_no) && ($old_OPD == $patient->old_reg_no) && ($ipd == 'opd')){ echo "color: #ff000d;font-weight: bold;"; } else { echo ""; } ?>">
                                    ...
                                    <td  style="padding:2px;"><?php if($patient->old_reg_no) { echo $patient->old_reg_no; if($explode[1]==''){echo ".".$fol_dot_year;}}?></td> <!-- //old patient no -->
                                    ...
                                    <td  style="padding:2px;">
                                        <?php
                                            if(stripos($patient->dignosis, 'VIDRADHI-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'MEDOJ GRANTHI-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'ABSCESS') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'PTERYGIUM - SKMI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'CHALAZION - SKMI') !== false){ echo $patient->dignosis; }
                                        ?>
                                    </td> 
                                    <td>
                                        <?php  
                                            if(stripos($patient->dignosis, 'ARSHA-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'PARIKARTIKA-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'BHAGANDAR-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'PERIANAL ABSCESS - SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'PILONIDLE SINUS-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'USHTRAGREEV BHAGANDAR -SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'PHYMOSIS - SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'RAKTARSHA-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'SENTINAL TAG-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'BHAGANDAR -SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'HYDROCELE-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'VATAJ ARSHA-SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'NIRUDDHA PRAKASHA- SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'PILONIDLE SINUS -SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'INTERNAL HAEMORRHOIDS - SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'ACUTE FISSURE IN ANO - SLI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'TYMPANIC MEMBRANE PERFORATION - SKMI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'TYMPANIC MEMBRANE PERFORATION- SKMI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'GILAYU SHOPH-SKMI') !== false){ echo $patient->dignosis; }
                                        ?>
                                    </td> 
                                    <td></td> 
