    ...
    <div  class="panel panel-default thumbnail">
        ...
        <div class="panel-body" style="font-size: 11px;">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
                ...
                <?php if($section == 'ipd'){ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"> IPD Other Panchkarma Procedure Summery Count Register</h3>
                ...
                <?php }else{ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"> OPD Other Panchkarma Procedure Summery Count Register</h3>
                    <h4 style="margin-top: 0px; margin-bottom: 15px;">Start Date:-  <?php echo date("d/m/Y", strtotime($datefrom))  ?>   To  <?php echo date("d/m/Y", strtotime($dateto)) ?> </h4>
                <?php  }  ?>
            </div>
            ...
            <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>1</td>
                        <td>UTTARBASTI</td>
                        <td><?php echo $resultData->uttarbastiCount; $grandTotal = $grandTotal + $resultData->uttarbastiCount;?></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>YONIDHAVAN</td>
                        <td><?php echo $resultData->yonidhavanCount; $grandTotal = $grandTotal + $resultData->yonidhavanCount;?></td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>YONIPICHU</td>
                        <td><?php echo $resultData->yonipichuCount; $grandTotal = $grandTotal + $resultData->yonipichuCount;?></td>
                    </tr>
                    <tr>
