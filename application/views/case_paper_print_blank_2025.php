...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php if($flag==1){ echo base_url('Patient_New/getpatientbydepartment_gob_date'); } else if($department_by=='dpt') { echo base_url('Patient_New/getpatientbydepartment_date'); } else { echo base_url('Patient_New/case_paper_print_date_blank'); }?>">
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" <?php  if($gob=='gob') { echo "style='font-size:10px;'";}?> style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style="width: 30px;"><?php echo display('address') ?></th>
                           <?php if($department_by !='dpt'){ ?> <th style="width: 30px;" rowspan="2"><?php echo "Department" ?></th> <?php } ?>
                            <th rowspan="2" style="width: 117px;" ><?php echo "Dignosis" ?></th>
                           <?php if($ipd=='opd'){ if($department_by !='dpt'){ ?><th style="width: 95px;" rowspan="2">Doctor Name</th><?php } }?>
                           
                            <?php if($ipd !='opd') { if($department_by !='dpt') {?><th style="width: 95px;" rowspan="2"><?php if($ipd == 'ipd'){ echo "Doctor" ;} else { echo "Date";}?></th> <?php }} ?>
                            
                            <?php if($department_by !='dpt') {?><?php if($ipd == 'ipd') { ?> <th style="width: 30px;" rowspan="2"> Bed No </th> <?php } ?><?php } ?> 
                            <!--<?php if($department_by !='dpt') {?> <th style="width: 30px;" rowspan="2"><?php if($ipd == 'ipd') { echo "Bed No";} ?></th><?php } ?>-->
                           ...
                           <?php if($department_by =='dpt') {?> <th style="width: 60px; <?php if($gob =='gob') { echo "font-size: 10px;";}?>" rowspan="2"><?php echo "RX4"?></th> <?php }?>  
                           <?php if($department_by  =='dpt') {?> <th style="width: 60px; <?php if($gob =='gob') { echo "font-size: 10px;";}?>" rowspan="2"><?php echo "RX5"?></th> <?php }?>  
                           <?php if($department_by =='dpt') {?> <th style="width: 60px; <?php if($gob =='gob') { echo "font-size: 10px;";}?>" rowspan="2"><?php echo "RX3"?></th> <?php }?>
                    ...
                    <tbody>
                       ...
                       // $this->db->where('discharge_date like','%0000-00-00%');
                        $this->db->where('create_date <=', date('Y-m-d',strtotime($dateto))." 23:59:00");
                        $this->db->where('create_date LIKE', $year2);
                            ...
                            //atya
                              ...
                              //st
                                 ...
                                 if($patient->manual_status==0){
			                      ...
			                      /// get address from patient opd table
			                       $datefrom1=date('Y-m-d',strtotime($datefrom));
                                   $year1 = date('Y',strtotime($datefrom));
                                   $year2='%'.$year1.'%';
			                      if(!empty($patient->yearly_reg_no)){
			                         $opd_address=$this->db->select("*")
                                     ->from('patient')
                                     ->where('yearly_reg_no',$patient->yearly_reg_no)
                                      ->where('create_date LIKE',$year2)
                                      ->get()
                                     ->row();
                                     $opd_address11=$opd_address->address;
                              ...
                              ?>
                                ...
                                ?>
                                    ...
                                    <td style="width: 159px;"  style="padding:2px;"><?php echo strtoupper($patient->firstname); ?></td>        
                                    <td  style="padding:2px;"><?php echo $patient->sex; ?></td>
                                    <td  style="padding:2px;"><?php echo $patient->date_of_birth; ?></td> 
                                    <td style="padding:2px;"><?php if($ipd == 'opd') { echo $patient->address; } else { echo $opd_address11;} ?></td>
                                   ...
                                   <?php 
                                    ...
                                    if($ipd == 'ipd'){ echo $doctor_name->firstname;} else { echo date('d-m-Y',strtotime($patient->create_date));}?></td><?php } ?> <?php } else {} ?>
                                     <?php if($department_by !='dpt' && $ipd == 'ipd') {?> <td  style="padding:2px;"><?php if($ipd == 'ipd') { echo $patient->bedNo;} else{ echo "";}?></td> <?php } ?>  
                                     
                                     <?php if($department_by =='dpt') {?> <td  style="padding:2px;<?php if($gob =='gob') { echo "font-size: 10px;";}?>"><?php if($RX1) { echo $RX1."<br>"; if($ANUPAN_RX1){ echo "Anupan - ".$ANUPAN_RX1."<br>";} } ?></td> <?php } ?>  
                                      <?php if($department_by =='dpt') {?> <td  style="padding:2px;<?php if($gob =='gob') { echo "font-size: 10px;";}?>"><?php if($RX2) { echo $RX2."<br>"; if($ANUPAN_RX2){ echo "Anupan - ".$ANUPAN_RX2."<br>";} } ?></td>  <?php }?> 
                                       <?php if($department_by =='dpt') {?> <td  style="padding:2px;<?php if($gob =='gob') { echo "font-size: 10px;";}?>"><?php if($RX3) { echo $RX3."<br>"; if($ANUPAN_RX3){ echo "Anupan - ".$ANUPAN_RX3."<br>";} } ?></td>  <?php }?> 
                                      <?php if($department_by =='dpt') {?> <td  style="padding:2px;<?php if($gob =='gob') { echo "font-size: 10px;";}?>"><?php if($RX4) { echo $RX4."<br>"; if($ANUPAN_RX4){ echo "Anupan - ".$ANUPAN_RX4."<br>";} } ?></td>  <?php }?> 
                                       <?php if($department_by =='dpt') {?> <td  style="padding:2px;<?php if($gob =='gob') { echo "font-size: 10px;";}?>"><?php if($RX5) { echo $RX5."<br>"; if($ANUPAN_RX5){ echo "Anupan - ".$ANUPAN_RX5."<br>";} } ?></td>  <?php }?> 
                       ...
                       <tbody>
                        ...
                        <tr>                
                         ...
                         <tr>                
                             ...
                             <td>एकूण</td> 
                           <td><?php echo ($at_tt + $at_ttan) - $at_ttdn; ?></td> 
                             <td><?php echo ($ky_tt + $ky_ttan) - $ky_ttdn; ?></td>   
                             <td><?php echo ($pn_tt + $pn_ttan) - $pn_ttdn; ?></td> 
                             <td><?php echo ($ba_tt + $ba_ttan) - $ba_ttdn; ?></td>   
                             <td><?php echo ($sly_tt + $sly_ttan) - $sly_ttdn; ?></td> 
                             <td><?php echo ($sky_tt + $sky_ttan) - $sky_ttdn; ?></td>   
                             <td><?php echo ($st_tt + $st_ttan) - $st_ttdn; ?></td> 
