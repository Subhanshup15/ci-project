...
<div class="row">
    <!--  table area -->
    <div class="col-sm-12">
        <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('stock/stock_import_report'); ?>">
 ...
 <div class="col-xs-2" ></div>
                    <div>
                        <div class="col-sm-12" align="center">
                            <h3><strong><?php echo "Stock Import Register"; ?></strong></h3>
                        ...
                        <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?//php print_r($stockImportData);?>
                                <?php $i=0;?>
                                <?php foreach($stockImportData as $stImpData){ ?>
                                    <tr>
