...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/getInvestigation_register_xray/'.$section); ?>">
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    ...
                    <tbody>
                       <?php
                            ...
                            // $query_d_m = $this->db->get('xray_patient_count_opd')->row();
                            // $num_d_m = $query_d_m->newCount;
                            //   print_r($this->db->last_query());


                            // $monthlySerialNo = $num_d_m;
                       ...
                       $a = 1;
                        ...
                        foreach($investiXRAYResult as $key => $pr){ ?>
                            <?php 
                                if($section == 'opd'){
                            ...
                            <tr>
                                ...
                                <td><?php echo ++$investiXRAYResultYearlyCount; ?></td>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $tot_array=array($investiXRAYResultCount->xrayCount);
                        ?> 
                        <?php $n = 1; ?>
