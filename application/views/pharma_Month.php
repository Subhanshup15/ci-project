...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php  echo base_url('patients/pharma_date_month/'.$pharmas.'/'.$department_by_section.'/0');  ?>">
                      ...
                      if($start==1){
                        $check_number_result=1;  
                          ...
                          $check_number_result=$check_number_q->num_rows;
                               ...
                               ?>
                   <center><h3 style="margin-top: 0px; margin-bottom: 15px;"><?php  if($pharmas=='churna') { echo 'Pharma Month Report';} else if($pharmas=='tablet') { echo 'Tablet Register';} else{ echo $pharmas."-".$department_by_section." Register";}?></h3>
 ...
 <div class="table-responsive">
  ...
  <table class="table table-bordered table-s" >
    <tr>
       ...
       <?php $m=0;foreach($pharma as $pharmas){ $m++;?>
       <?php 
                                   // $date=date('Y',strtotime($pharmas->name));
                                    //$dot_year=substr($date,2);
                                   //  $explode=explode('.',$pharmas->old_reg_no);
			                       //print_r($import);
                                  //  $explode[1];
                                     ?>
        <th><?php  $pharmas->name;  //echo implode('<br>',str_split(strrev($cc))); ?></th>
       <?php }?>
    ...
    ?><tr>
       ...
       <td><?php echo  implode('<br>',str_split(strrev($pharma1->name)));?></td>
    <?php    
  ...
  <table class="table table-bordered table-hover">
    <tr>
       ...
       <?php $m=0;foreach($patients__date as $pharmass){ $m++;?>
        <th ><?php  echo $m; //echo implode('<br>',str_split(strrev($pharmass->daily_date))); ?></th>
       <?php }?>
    ...
    <?php     
        ...
        $dateee=$this->db->select("daily_date,sum(daily_use) as tot")
    ...
    ?>
       ...
       <?php } } }?>
              ...
              <!--  <h3>Report Summary</h3>-->
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" <?php if($fisrt_hide) { echo 'style="display:none"'; }?>  style="display:none";>
                    <thead>
                        <tr>
                            <th style="width: 30px;" ><?php echo "S.No" ?></th>
                             <th style="width: 30px;" ><?php echo "Name" ?></th>
