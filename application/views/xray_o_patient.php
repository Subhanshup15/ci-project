         ...
         <div class="panel-body panel-form">
           ...
           <?//php echo form_open_multipart('patients/save_pharma_patient_count','class="form-inner"') ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <lable>X_RAY</lable>
                    <input type="text" name="X_RAY" id="X_RAY" placeholder="X_RAY" class="form-control" readonly>
                </div>
...
$(document).ready(function() {
    $('body').on('keyup change', '#date', function() {
        ...
        $.ajax({
            ...
            url     : '<?php echo base_url('patients/fetch_patient_xray') ?>',
    ...
    $('body').on('keyup change', '#patient_name', function() {
        ...
        $.ajax({
            ...
            url     : '<?php echo base_url('patients/fetch_treatment_xray') ?>',
            ...
            success : function(data) {
                if (data.status == true) {
                   $('#tests').empty();
                    ...
                    if(X_RAY){
                    $('#tests').append(
                                         '<input type="test" name="X_RAY_final" id="X_RAY_final" readonly="readonly" value="' + X_RAY + '"><br><br>'
                            );
                    }
                    if(X_RAY){
                    $('#tests').append(
                                        //  '<input type="text" name="xray_result" id="xray_result"><br>'
                                         '<textarea id="xray_result" placeholder="Add Result" name="xray_result" rows="4" cols="50">'
                            );
                    }
...
$("#submit").click(function(){
        ...
        var X_RAY = $('#X_RAY_final').val();
        var xray_result = $('#xray_result').val();
        ...
        $.ajax({
            ...
            url:'<?php echo base_url('patients/save_xray_data') ?>',
