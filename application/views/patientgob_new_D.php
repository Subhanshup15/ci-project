...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php if($flag==1){ echo base_url('patients/getpatientbydepartment_gob_date1_d'); } else if($department_by=='dpt') { echo base_url('patients/getpatientbydepartment_date1'); } else { echo base_url('patients/patient_by_date'); }?>">
                   ...
                   <h3 style="margin-top: 0px; margin-bottom: 0px;"><strong><?php echo $this->session->userdata('title') ?></strong></h3>
                    ...
                    <?php   
                        ...
                        //    }
                                ...
                                $year = $this->session->userdata['acyear'];
                                if ($department_id) {
                                    $table = ($year == 2025) ? 'department_new' : 'department';
                                    $dept_name = $this->db->select("*")
                                        ->from($table)
                                        ->where('dprt_id', $department_id)
                                        ->get()
                                ...
                                if ($dept_id) {
                                    ...
                                    $dept_name = $dept_name ? $dept_name->name : '';
                                } else {
                                    $dept_name = '';
                                }
                                $ipd = ($patients[0]->ipd_opd);
                        ...
                        if($ipd =='ipd'){ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php if($name) { echo "Departmental ";} elseif($gob=='gob'){ echo "IPD DURGS DISTRIBUTION"; } else { echo "Central";} ?>  <?php if($name=='Swasthrakshnam'){ echo "(".$name." -KC)";} elseif($name){ echo"(".$name.")" ; } elseif($dept_name){ echo"(".$dept_name.")" ;}?></h3>
