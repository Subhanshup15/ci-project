...
<div class="row">
    ...
    <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/get_investi_p')?>">
        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading  row" id="PrintMe">
                ...
                <div class="col-lg-12" style="text-align:center;margin-top: 10px;margin-bottom: 10px;">
                    ...
                    if($section == 'ipd'){
                    ?>
                    <h2>Investigation Report IPD</h2>
                    <?php } else { ?>
                    <h2>Investigation Report OPD</h2>
                    <? } ?>
                </div>
            ...
            <div class="panel-body">
                <table width="100%" id="patientdata" class=" table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if (!empty($investigation_report)) {
                   //     print_r($haematology);
                         // $test = $haematology->hematology;
                        ?>
                            <?php $sl = 1;
?>
                            <?php foreach ($investigation_report as $hm) {  ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center no-print">
                                        <a href="<?php echo base_url("patients/get_investi_patient_profile/$hm->patient_auto_id/$section") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
