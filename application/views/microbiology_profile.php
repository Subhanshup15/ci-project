<div class="row">
    ...
    <div class="col-sm-12" id="PrintMe">
        ...
        <div  class="panel panel-default thumbnail" style="border:none;">
            ...
            <?php
                $patient_auto_id = $microbiology_profile[0]->patient_auto_id;
  ...
  { $table='patient_ipd'; }
				  					$name = $this->db->select('*')->from($table)->where('id',$microbiology_pro[0]->name)->get()->row();
  									if($name)
                                    {
                                      echo $name->firstname;
                                    }else {
  									echo $microbiology_pro[0]->name;  }  
                                  
                                  ?></strong></div>
                                <div class="col-xs-6"><strong> Date:</strong> <strong><?php echo date('d-m-Y',strtotime($microbiology_pro[0]->create_date)); ?></strong></div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-xs-6"><strong>Gender:</strong> <?php if($microbiology_profile[0]->sex == 'M'){ echo "Male"; } else{ echo"Female"; }?></strong></div>
                                <div class="col-xs-6"><strong>Age:</strong> <?php echo $microbiology_profile[0]->date_of_birth; ?></strong></div>
                            </div>
                        </div>
