...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/National_date'); ?>">
            ...
            <div class="col-sm-12">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
                    ...
                    <?php   
                        ...
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php echo "National Health Programme Register"; ?></h3>
