...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/Manas_date'); ?>">
            ...
            <div class="col-sm-8" align="center">  
                   <h3 style="margin-top: 0px; margin-bottom: 0px;"><strong><?php echo $this->session->userdata('title') ?></strong></h3>
                    ...
                    <?php   
                        ...
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php echo "Manas Rog Register"; ?></h3>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    <thead>
                        <tr>
                           ...
                           <?php if($department_by =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php  echo "Phone Number";?></th> <?php }?> 
