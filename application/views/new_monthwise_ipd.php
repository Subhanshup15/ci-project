...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('PatientNew/new_monthwise_ipd'); ?>">
...
<div class="col-sm-12" id="PrintMe">
        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="col-sm-12" align="center">  
                ...
                <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php echo "MONTHWISE D-IPD REPORT"; ?></h3>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        foreach ($department as $dept): 
                            ...
                            // Calculate row total for the current department
                            for ($j = 1; $j <= 12; $j++) {
                                $row_total += isset($monthwise_data[$dept->dprt_id][$j]) 
                                            ? $monthwise_data[$dept->dprt_id][$j] 
                                            : 0;
                            }

                            // Display the department only if the row total is greater than zero
                            if ($row_total > 0): 
                        ?>
                            <tr>
                                <td><?php echo $a++; ?></td>
