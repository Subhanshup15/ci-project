...
<div class="row">
    ...
    <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('laboratory/listseologicaldate')?>">
        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print row">
                <div class="btn-group col-md-2"> 
                    <a class="btn btn-success" href="<?php echo base_url("laboratory/seological") ?>"> <i class="fa fa-plus"></i>  Add </a>  
                </div>
...
?>
                            <?php $i = 0; foreach ($labs as $lab) { $i++; ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("laboratory/profileseological/$lab->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                        <a href="<?php echo base_url("laboratory/editseological/$lab->id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
