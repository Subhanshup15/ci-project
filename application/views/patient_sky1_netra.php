...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php  echo base_url('patients/getpatientbydepartment_date_sky1_netra'); ?>">
           ...
           <div class="col-sm-2" align="left">
            ...
            <div class="col-sm-8" align="center">  
                   <h3 style="margin-top: 0px; margin-bottom: 0px;"><strong><?php echo $this->session->userdata('title') ?></strong></h3>
                    ...
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"> Departmental Register of Out Patient Department Shalakyatantra (<?php echo $netra; ?>)</h3>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" <?php  if($gob=='gob') { echo "style='font-size:10px;'";}?>>
                    ...
                    <thead>
                        <tr>
							...
							<?php if($ipd == 'opd'){ ?> <th style="width: 30px;" rowspan="2"><?php echo "Date"; ?></th><?php } ?>
                           
                            <th rowspan="2"><?php echo "Patient Name" ?></th>   
                            <th rowspan="2" <?php  if($department_by=='dpt') { echo "style='width:1px;'";}?>><?php echo "Full Address" ?></th> 
                            ...
                            <th rowspan="2" <?php  if($department_by=='dpt') { echo "style='width:1px;'";}?>><?php echo "Department" ?></th>                  
