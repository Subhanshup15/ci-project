         ...
         <div class="panel-body panel-form">
           ...
           <?//php echo form_open_multipart('patients/save_pharma_patient_count','class="form-inner"') ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <lable>USG</lable>
                    <input type="text" name="USG" id="USG" placeholder="USG" class="form-control" readonly>
                </div>
...
$(document).ready(function() {
    $('body').on('keyup change', '#date', function() {
        ...
        $.ajax({
            ...
            url     : '<?php echo base_url('patients/fetch_patient_usg') ?>',
    ...
    $('body').on('keyup change', '#patient_name', function() {
        ...
        $.ajax({
            ...
            url     : '<?php echo base_url('patients/fetch_treatment_usg') ?>',
            ...
            success : function(data) {
                if (data.status == true) {
                   $('#tests').empty();
                    ...
                    if(USG){
                    $('#tests').append(
                                         '<input type="test" name="USG_final" id="USG_final" readonly="readonly" value="' + USG + '"><br><br>'
                            );
                    }
                    if(USG){
                    $('#tests').append(
                                        //  '<input type="text" name="xray_result" id="xray_result"><br>'
                                         '<textarea id="usg_result" placeholder="Add Result" name="usg_result" rows="4" cols="50">'
                            );
                    }
...
$("#submit").click(function(){
        ...
        var USG = $('#USG_final').val();
        var usg_result = $('#usg_result').val();
        ...
        $.ajax({
            ...
            url:'<?php echo base_url('patients/save_usg_data') ?>',
