...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/getpatientby_investigation_date_ecg'); ?>">
            ...
            <div class="col-sm-12" align="center">  
                ...
                <p class="text-center"><?php echo $this->session->userdata('address') ?></p>
                    ...
                    <?php   
                        ...
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php echo "ECG REGISTER"; ?></h3>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2"><?php echo "Name of Patient" ?></th> 
                          ...
                          <!-- <?php if($department_by =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php  echo "USG";?></th> <?php }?> -->
                           <th style="width: 30px;" rowspan="2"><?php  echo "SECTION";?></th>
                            <?php   
...
?>
                            <?php  $array_patho1= array(); $array_patho2= array(); $array_patho3= array(); 
                              ...
                              ?>
                                ...
                                <?php if($ECG !='') {?><tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else { echo ""; } ?>">
                                    
                                       
                                    <?php if($getpatientbydepartment_date =='D'){ ?>
                                    <td style="padding:2px;"><?php if($ECG !='') { echo $Sr_no++ ;} else{ echo $Sr_no++; } ?></td>
                                    <?php } else {?>
                                    <td style="padding:2px;"><?php if($ipd == 'ipd'){ echo $i;} else { echo $tot_serial1; }?> </td> <?php } ?>
			                       ...
			                       ->where('department_id', $patient->department_id) 
                                    ...
                                    <td  style="padding:2px;"><?php echo  $patient->ipd_opd;  ?></td>     
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                               ...
                               <!-- <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "1";?> </td>
                                    <td><?php echo "HEMATOLOGICAL"; ?></td> 
                                    <td><?php echo $HEMATOLOGICAL1; ?></td>
                                </tr>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "2";?> </td>
                                    <td><?php echo "SEROLOGYCAL"; ?></td> 
                                    <td><?php echo $SEROLOGYCAL1; ?></td>
                                </tr>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "3";?> </td>
                                    <td><?php echo "BIOCHEMICAL"; ?></td> 
                                    <td><?php echo $BIOCHEMICAL1; ?></td>
                                </tr>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "4";?> </td>
                                    <td><?php echo "MICROBIOLOGICAL"; ?></td> 
                                    <td><?php echo $MICROBIOLOGICAL1; ?></td>
                                </tr>
                                
                                 <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "5";?> </td>
                                    <td><?php echo "X-RAY"; ?></td> 
