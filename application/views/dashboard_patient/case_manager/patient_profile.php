                                            ...
                                            <?php foreach ($documents as $document) { ?>
                                                <tr>
                                                    ...
                                                    <td class="center no-print" width="80">
                                                        ...
                                                        <a href="<?php echo base_url("dashboard_patient/case_manager/patient/document_delete/$document->id?file=$document->hidden_attach_file") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                                    </td>
                                                </tr>
                                                <?php $sl++; ?>
                                            <?php } ?> 
