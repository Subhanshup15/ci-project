      ...
      <div  class="panel panel-default thumbnail">
         ...
         <div class="panel-body panel-form">
                <?php 
                    ...
                    {
                        $dignosis_p = $haematology_profile_opd[0]->dignosis;
            ...
            <?//php echo form_hidden('id',$lab->id); ?> 
                  ...
                  <div class="col-lg-12" style="margin-top:20px;">
                    ...
                    <?//php foreach($haematology_profile_opd as $report) { ?>
                              <tr>
                                  <td><input name="test_name[]" autocomplete="off" type="text" class="form-control" id="test_name" placeholder="" value="<?php echo $pp->test_name; ?> " readonly></td>
                                  ...
                                  <td><input name="normal_value[]" autocomplete="off" type="text" class="form-control" id="normal_value" placeholder="" value="<?php echo $pp->reference_range; ?>" readonly>
                                        ...
                                        <input name="report_type[]" autocomplete="off" type="hidden" class="form-control" id="report_type" placeholder="" value="<?php echo $pp->test_type; ?>" readonly>
