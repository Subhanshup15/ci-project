...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php  base_url('patients/patient_diet');?>">
        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-body" style="font-size: 11px;">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
                    ...
                    <h3 style="margin-top: 0px; margin-bottom: 15px;">Patient Diet Register</h3>
                ...
                <table width="100%" id="patientdata"  class="table table-striped table-bordered table-hover">
                  ...
                  <?php foreach($patient_data as $patient) $i=1; {?>
                   <tbody>
                       <tr>
                           <td><?php echo $i; ?></td>
