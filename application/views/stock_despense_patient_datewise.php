...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php  echo base_url('stock/patient_report_datewise'); ?>">
        ...
        <div class="panel-body" style="font-size: 11px;">
            ...
            <table class="table table-bordered table-hover table-striped">
                <tr>
                    ...
                    <th>Name</th>
                    <?php 
  				$tablets = $this->db->select('*')->from('pharma1')->get()->result(); 
               ...
               if($patient->RX1_despense != '0')
               {
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <?php if($section == 'opd'){ ?>
                      <b><a style='color:red;' ><?php echo $total = $t->RX1_despense; ?></a></b>
                     <?php } else { ?>
                      <b><a class="no-print withhref" id="withhref" style='color:red;' >
                        <?php 
