                          ...
                          if($department_id){
			               ...
			               $name= $dept_name->name;
                               ...
                               $ipd = ($patients[0]->ipd_opd);
                                ...
                                if($ipd == 'ipd'){ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php if($name) { echo "Departmental ";} else {echo "Date";} ?> Wise Investigation <?php if($name=='Swasthrakshnam'){ echo "(".$name." -KC)";} elseif($name){ echo"(".$name.")" ; }?></h3>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    ...
                                    <td><?php echo $HEMATOLOGICALTestCount + $SEROLOGYCALTestCount + $BIOCHEMICALTestCount + $MICROBIOLOGICALTestCount + $X_RAYTestCount + $ECGTestCount + $USGTestCount; ?></td>
                                </tr>
