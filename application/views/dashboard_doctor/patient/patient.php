...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('dashboard_doctor/patient/patient/patient_by_date')?>">
                            ...
                            <?php $i = 0; foreach ($patients as $patient) { $i++; ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        ...
                                        <!-- <a href="<?php echo base_url("dashboard_doctor/patient/patient/$patient->ipd_opd/edit/$patient->id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>  -->
                                        <a href="<?php echo base_url("dashboard_doctor/patient/patient/$patient->ipd_opd/delete/$patient->id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>')"><i class="fa fa-trash"></i></a> 
                                    </td>                                     
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
...
$(document).ready(function(){
  $('#btn_excel_download').click(function(){
            ...
            "serverSide": true,		
        "ajax":{
            "url": "<?php echo base_url('dashboard_doctor/patient/patient/opd')?>",
            "type": "POST",
...
<script>
						$(document).ready(function(){
							$("#dischargedate").click(function(){
								...
								$.ajax({
									url: "<?php echo base_url(); ?>dashboard_doctor/patient/patient/dischargedate/" + discharge_date + "/" + yearly_no,
									method: "POST",
									//data: {"otp": otp},
									dataType: "json",
                                    data: {
