            ...
            <div class="row">
               ...
               <div class="col-md-6 col-sm-12">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-xs-9">
                        <input name="yearly_no" autocomplete="off" type="text" class="form-control" id="yearly_no" placeholder="<?php echo display('yearly_no') ?>" value="<?php echo $patient->yearly_no ?>">    
                     </div>
                  </div>         
   ...
   $(document).ready(function() {
       ...
       $('#old_reg_no').keyup(function(){
           ...
           $.ajax({
               ...
               url  : '<?= base_url('dashboard_doctor/patient/patient/check_patient/') ?>',
       ...
       $("#department_id").change(function(){
           ...
           $.ajax({
               ...
               url  : '<?= base_url('dashboard_doctor/appointment/appointment/doctor_by_department') ?>',
       ...
       $("#doctor_id").change(function(){
           ...
           $.ajax({
               ...
               url  : '<?= base_url('dashboard_doctor/appointment/appointment//schedule_day_by_doctor/') ?>',
       ...
       $("#date").change(function(){
           ...
           $.ajax({
               ...
               url  : '<?= base_url('dashboard_doctor/appointment/appointment//serial_by_date/') ?>',
