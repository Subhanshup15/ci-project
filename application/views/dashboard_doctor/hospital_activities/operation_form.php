    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_doctor/hospital_activities/operation") ?>"> <i class="fa fa-list"></i>  <?php echo display('operation_report') ?> </a>  
                </div>
            </div> 
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('dashboard_doctor/hospital_activities/operation/form/'.$operation->id,'class="form-inner"') ?>

                            <?php echo form_hidden('id',$operation->id) ?>
                            <?php echo form_hidden('doctor_id',$operation->doctor_id) ?>
