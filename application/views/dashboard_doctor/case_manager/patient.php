                    ...
                    <tbody>
                        <?php if (!empty($patients)) { ?>
                            ...
                            <?php foreach ($patients as $patient) { ?>
                                <tr>
                                    <td><?php echo $sl; ?></td>
                                    <td><a href="<?php echo base_url("dashboard_doctor/case_manager/patient/profile/$patient->id"); ?>"><?php echo $patient->patient_id ?></a></td>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("dashboard_doctor/case_manager/patient/profile/$patient->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
