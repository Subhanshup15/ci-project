...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/getInvestigation_register/'.$section); ?>">
            ...
            <div class="panel-body" style="font-size:<?php if($patients[0]->ipd_opd =='ipd'){ echo "9px";} else { echo "11px"; }?> ;">
                <div class="row">
                    ...
                    <div class="col-sm-8" align="center">  
                        ...
                        <?php }else{ ?>
                            <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php if($name) { echo "D-OPD Karma Panch ";} else {echo " Date Wise OPD Investigation Register ";}?> <?php  if($name) {echo "(".$name.")";}?></h3>
                            <h4 style="margin-top: 0px; margin-bottom: 15px;">Start Date:-  <?php echo date("d/m/Y", strtotime($datefrom))  ?>   To  <?php echo date("d/m/Y", strtotime($dateto)) ?> </h4>
                        <?php } ?>
                    </div>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    ...
                    <tbody>
                        ...
                        <?php foreach($investiResult as $key => $pr){ ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo ++$investiResultYearlyCount; ?></td>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $tot_array=array($investiResultCount->hematologyCount, $investiResultCount->serologyCount, $investiResultCount->biochemistryCount, $investiResultCount->microbiologyCount);
                        ?> 
                        <?php $n = 1; ?>
