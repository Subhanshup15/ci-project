                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "patient") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url("dashboard_receptionist/patient/patientList/opd") ?>">Central OPD Patient</a></li> 
                                <li><a href="<?php echo base_url("dashboard_receptionist/patient/patientList/ipd") ?>">Central IPD Patient</a></li>
                            </ul>
