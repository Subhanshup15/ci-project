            ...
            <div class="form-group col-sm-12">
                <div class="form-group row"> 
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-xs-9">
                            <input name="opd_no" class="form-control" type="text" placeholder="" id="opd_no"  value="<?php if($patient->yearly_reg_no!=''){ echo $patient->yearly_reg_no; }else{ echo $patient->daily_reg_no; } ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group row"> 
                ...
                <div class="form-group row"> 
                           ...
                           $department_list = $this->db->get($departmentTable)->result();
                            ...
                            <select name="department_id" id="department_id" class="select2 form-control">
                                ...
                                <?php foreach($department_list as $x => $x_val ){ ?>
                                    <option value="<?php echo $x_val->dprt_id; ?>" <?php if($patient->department_id!='' && $x_val->dprt_id==$patient->department_id){echo "Selected";}?>><?php echo $x_val->name; ?></option>
                                <?php }?>
                            </select>
                     </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-xs-9">
                            <?php   
                                $segment=$this->uri->segment(4); if($segment == 'ipd'){ 
                                $section_tret='ipd';
                                ...
                                $diagnosis = $p_dignosis_name; 
                                
                                $this->load->model('department_model');
                                $dignosis_list = $this->department_model->dignosis_list();
                            ?>
                            <input name="dignosis" class="form-control" type="text" placeholder="" id="dignosis"  value="<?php echo $patient->dignosis; ?>" required>
                            
                            <!--<select name="dignosis" id="dignosis" class="select2 form-control">-->
                            <!--    <option value="">Select</option>-->
                            <!--    <?php foreach($dignosis_list as $x => $x_val ){ ?>-->
                            <!--        <option value="<?php echo $x_val; ?>" <?php if($diagnosis!='' && $x_val==$diagnosis){echo "Selected";}?>><?php echo $x_val; ?></option>-->
                            <!--    <?php }?>-->
                            <!--</select>-->
                ...
                <div class="form-group" style="padding-right:none;padding-left:none;">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <div class="row">
                            <input type="text" name="dose_anupan_rx1" id="dose_anupan_rx1" class="form-control" value="<?php if($result1!='' && $result1->RX1_dose_anupan){echo $result1->RX1_dose_anupan;}?>" placeholder="Anupan"/>
                        </div>
                    </div>
                </div>
                <div class="form-group" style="padding-right:none;padding-left:none;">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <div class="row">
                            <input type="text" name="dose_anupan_rx2" id="dose_anupan_rx2" class="form-control" value="<?php if($result1!='' && $result1->RX2_dose_anupan){echo $result1->RX2_dose_anupan;}?>" placeholder="Anupan"/>
                        </div>
                    </div>
                </div>
                <div class="form-group" style="padding-right:none;padding-left:none;">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <div class="row">
                            <input type="text" name="dose_anupan_rx3" id="dose_anupan_rx3" class="form-control" value="<?php if($result1!='' && $result1->RX3_dose_anupan){echo $result1->RX3_dose_anupan;}?>" placeholder="Anupan"/>
                        </div>
                    </div>
                </div>
                <div class="form-group" style="padding-right:none;padding-left:none;">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <div class="row">
                            <input type="text" name="dose_anupan_rx4" id="dose_anupan_rx4" class="form-control" value="<?php if($result1!='' && $result1->RX4_dose_anupan){echo $result1->RX4_dose_anupan;}?>" placeholder="Anupan"/>
                        </div>
                    </div>
                </div>
                <div class="form-group" style="padding-right:none;padding-left:none;">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <div class="row">
                            <select name="RX6" id="RX6" class="select2 form-control">
                                <option value="">Select</option>
                                <?php foreach($treatment_list_rx6 as $x => $x_val ){ ?>
                                    <option value="<?php echo $x_val->name; ?>" <?php if($result1!='' && $x_val->name==$result1->RX6_medicine_name){echo "Selected";}?>><?php echo $x_val->name; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                            ...
                            <select name="NASYA" id="NASYA" class="form-control">
                               <option value="">Select NASYA</option>
                                <?php foreach($treatment_list_patho as $x => $x_val ){ ?>
                                    <option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->NASYA){echo "Selected";}?>><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="SROTAS" id="SROTAS" class="form-control">
                                ...
                                <?php foreach($treatment_list_srotas as $x => $x_val ){ ?>
                                    <option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->SROTAS){echo "Selected";}?>><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="DOSHA" id="DOSHA" class="form-control">
                                ...
                                <?php foreach($treatment_list_dosha as $x => $x_val ){ ?>
                                    <option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->DOSHA){echo "Selected";}?>><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="DUSHYA" id="DUSHYA" class="form-control">
                                ...
                                <?php foreach($treatment_list_dushya as $x => $x_val ){ ?>
                                    <option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->DUSHYA){echo "Selected";}?>><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="skarma" id="skarma" class="form-control">
                                ...
                                <?php foreach($treatment_list_skarma as $x => $x_val ){ ?>
                                    <option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->skarma){echo "Selected";}?>><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="vkarma" id="vkarma" class="form-control">
                                ...
                                <?php foreach($treatment_list_vkarma as $x => $x_val ){ ?>
                                    <option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->vkarma){echo "Selected";}?>><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                            ...
                            <select name="swa1" id="swa1" class="form-control">
                               <option value="">Select RAKTAMOKSHAN</option>
                                <?php foreach($treatment_list_swa11 as $x => $x_val ){ ?>
                                    <option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->SWA1){echo "Selected";}?>><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="swa2" id="swa2" class="form-control">
                                ...
                                <?php foreach($treatment_list_swa12 as $x => $x_val ){ ?>
                                    <option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->SWA2){echo "Selected";}?>><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="hematological[]" id="HEMATOLOGICAL" class="form-control" multiple>
                                ...
                                <?php foreach($treatment_list_HEMATOLOGICAL as $x => $x_val ){ ?>
                                    <!--<option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->HEMATOLOGICAL){echo "Selected";}?>><?php echo $x_val; ?></option>-->
                                    <option value="<?php echo $x; ?>"><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                            <label id="HEMATOLOGICAL_label"><?php if($result1!=''){if($result1->HEMATOLOGICAL){echo $result1->HEMATOLOGICAL;}}?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group row"> 
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="serologycal[]" id="SEROLOGYCAL" class="form-control" multiple>
                                ...
                                <?php foreach($treatment_list_SEROLOGYCAL as $x => $x_val ){ ?>
                                    <!--<option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->SEROLOGYCAL){echo "Selected";}?>><?php echo $x_val; ?></option>-->
                                    <option value="<?php echo $x; ?>"><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                            <label id="SEROLOGYCAL_label"><?php if($result1!=''){if($result1->SEROLOGYCAL){echo $result1->SEROLOGYCAL;}}?></label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <!--<?php echo form_dropdown('treatment_id',$digno_sub_list,$patient->id_digno_sub,'class="form-control" id="treatment_id" onclick="myfunction(this.value)"') ?>-->
                            <select name="biochemical[]" id="MICROBIOLOGICAL" class="form-control" multiple>
                                ...
                                <?php foreach($treatment_list_MICROBIOLOGICAL as $x => $x_val ){ ?>
                                    <!--<option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->MICROBIOLOGICAL){echo "Selected";}?>><?php echo $x_val; ?></option>-->
                                    <option value="<?php echo $x; ?>"><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                            <label id="MICROBIOLOGICAL_label"><?php if($result1!=''){if($result1->MICROBIOLOGICAL){echo $result1->MICROBIOLOGICAL;}}?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group row"> 
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="microbiological[]" id="BIOCHEMICAL" class="form-control" multiple>
                                ...
                                <?php foreach($treatment_list_BIOCHEMICAL as $x => $x_val ){ ?>
                                    <!--<option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->BIOCHEMICAL){echo "Selected";}?>><?php echo $x_val; ?></option>-->
                                    <option value="<?php echo $x; ?>"><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                            <label id="BIOCHEMICAL_label"><?php if($result1!=''){if($result1->BIOCHEMICAL){echo $result1->BIOCHEMICAL;}}?></label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="xray[]" id="X_RAY" class="form-control" multiple>
                                ...
                                <?php foreach($treatment_list_x_ray as $x => $x_val ){ ?>
                                    <!--<option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->X_RAY){echo "Selected";}?>><?php echo $x_val; ?></option>-->
                                    <option value="<?php echo $x; ?>"><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                            <label id="X_RAY_label"><?php if($result1!=''){if($result1->X_RAY){echo $result1->X_RAY;}}?></label>
                        </div>   
                    </div>
                </div>
                <div class="form-group row"> 
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="ECG" id="ECG" class="form-control">
                                ...
                                <?php foreach($treatment_list_ecg as $x => $x_val ){ ?>
                                    <option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->ECG){echo "Selected";}?>><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-9">
                            ...
                            <select name="usg[]" id="USG" class="form-control select2" multiple>
                                ...
                                <?php foreach($treatment_list_usg as $x => $x_val ){ ?>
                                    <!--<option value="<?php echo $x; ?>" <?php if($result1!='' && $x==$result1->USG){echo "Selected";}?>><?php echo $x_val; ?></option>-->
                                    <option value="<?php echo $x; ?>"><?php echo $x_val; ?></option>
                                <?php }?>
                            </select>
                            <label id="USG_label"><?php if($result1!=''){if($result1->USG){echo $result1->USG;}}?></label>
                        </div>
                    </div>
                </div>
