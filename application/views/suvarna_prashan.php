        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print row">
                ...
                <div class="btn-group col-md-2"> 
                    <a class="btn btn-success" href="<?php echo base_url("patients/suvarna_prashana_camp") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_patient') ?> </a>  
                </div>              
           ...
           <div class="col-sm-12">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
                    ...
                    <?php   
                        ...
                        <h3 style="margin-top: 0px; margin-bottom: 15px;">Suvarna Prashan Register</h3>
               ...
               <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style="width: 30px;"><?php echo "Name" ?></th> 
                            <th style="width: 30px;" rowspan="2"><?php echo "Age" ?></th>  
                             <th style="width: 30px;" rowspan="2"><?php echo "Gender" ?></th>  
                            <th style="width: 30px;" rowspan="2"><?php echo "Weight" ?></th>  
                            ...
                            <th style="width: 30px;" rowspan="2">Phone</th> 
                            <th style="width: 30px;" class="no-print" rowspan="2"><?php echo display('action') ?></th>                      
                         </tr>
                    </thead>
                    <tbody>
                            ...
                            <?php  $array_patho1= array(); $array_patho2= array(); $array_patho3= array(); 
                              ...
                              ?>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else { echo ""; } ?>">
                                    ...
                                    <td  style="padding:2px;"><?php echo $patient->wieght; ?></td>
