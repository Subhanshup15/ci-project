...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php  echo base_url('stock/stock_despence_churn_tablet_kadha'); ?>">
           ...
           <div class="col-sm-12" align="center">
            ...
            <table class="table table-bordered table-hover table-striped">
                <tr>
  				...
  				$tablets = $this->db->select('*')->from('pharma1_kadha_oil')->where('status','1')->get()->result(); 
            ...
            //  print_r($patients);
                $i = 1;
                  ...
                  if($section == 'opd'){
                        ...
                        $query_d = $this->db->get('kadha_daily_opd_patient');
                        ...
                        $this->db->where('create_date <=', $ddd);
                        $this->db->where('create_date LIKE', $year2);
                        $query_dd = $this->db->get('kadha_daily_opd_patient');
               ...
               if($section == 'ipd'){
                        ...
                        $this->db->where('create_date <=', $ddd);
                        $this->db->where('create_date LIKE', $year2);
                        $query_d = $this->db->get('kadha_daily_ipd_patient');
                        $num_d = $query_d->num_rows();//0
                        ...
                        $this->db->where('create_date <=', $ddd);
                        $this->db->where('create_date LIKE', $year2);
                        $query_dd = $this->db->get('kadha_daily_ipd_patient');
                        $num1_d = $query_dd->num_rows();
                  ...
                  if($section == 'ipd'){
                   // patient ipd yearly no
                                 ...
                                 // $this->db->where('create_date <=', $d_ipd_no);
                                  $this->db->where('create_date LIKE', $year2);
                                  $query = $this->db->get('kadha_daily_ipd_patient');
               ...
               if($patient->RX1_despense != '0')
               {
                ...
                <tr>
                  ...
                  <td><b><?php echo $opd_number; ?></b></td>
                    ...
                    <td>
                      ...
                      <?php if($section == 'opd'){ ?>
                      <?php  
                        if(strpos($t->tab_name, 'GHRITA') !== false || strpos($t->tab_name, 'GHRUT') !== false)
                        {
                            $unit = 'g';
                        } else{
                            $unit = 'ml';
                      ...
                      ?>
                      <b style='color: red;'><?php echo $total = $t->RX1_despense.'('.$unit.')'; ?></b>
                ...
                ?>
                	<td style="color:red;">
                      ...
                      <b>
                        <?php
                          if(strpos($tb->tab_name, 'GHRITA') !== false || strpos($tb->tab_name, 'GHRUT') !== false)
                        {
                            $unit = 'g';
                        } else{
                            $unit = 'ml';
