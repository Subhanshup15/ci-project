...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/getInvestigation_register_testwise1/'.$section); ?>">
            ...
            <div class="panel-body" style="font-size:<?php if($patients[0]->ipd_opd =='ipd'){ echo "9px";} else { echo "11px"; }?> ;">
                <div class="row">
                    ...
                    <div class="col-sm-8" align="center">  
                        ...
                        <?php if($section == 'ipd'){ ?>
                            <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php if($name) { echo "D-IPD Karma Panch";} else {echo "IPD Investigation Register";} ?>  <?php if($name=='Swasthrakshnam'){ echo "(".$name." -KC)";} elseif($name){ echo"(".$name.")" ; }?></h3>
                        ...
                        <?php }else{ ?>
                            <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php if($name) { echo "D-OPD Karma Panch ";} else {echo " OPD Investigation Register";}?>   <?php  if($name) {echo "(".$name.")";}?></h3>
                            <h4 style="margin-top: 0px; margin-bottom: 15px;">Start Date:-  <?php echo date("d/m/Y", strtotime($datefrom))  ?>   To  <?php echo date("d/m/Y", strtotime($dateto)) ?> </h4>
                        <?php } ?>
                    </div>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    ...
                    <tbody>
                       <?php foreach($investiResultTest as $key => $pr){ ?>
                            <?php 
                                if($section == 'opd'){
                            ...
                            <tr>
                                ...
                                <td class="center no-print"  style="padding:2px;">
                                    ...
                                    <?php }else { ?>
                                        <a href="<?php echo base_url("patients/hemeto_profile1/$patient->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>      
                                    <?php } ?>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $tot_array=array($investiResultCountTest->hematologyCount, $investiResultCountTest->serologyCount, $investiResultCountTest->biochemistryCount, $investiResultCountTest->microbiologyCount);
                        ?> 
                        <?php $n = 1; ?>
