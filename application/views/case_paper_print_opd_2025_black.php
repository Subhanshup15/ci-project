                            ...
                            <tbody>
                                 <tr>
                                    ...
                                    <td style="border-left: 1px solid #333; border-right: 1px solid #333;">
                                        <?php                          
                                        echo (!empty($profile->fol_up_date)?
                                        date('d-m-Y', strtotime($profile->fol_up_date))
                                        :(!empty($profile->create_date) 
                                        && !empty($profile->yearly_reg_no)
                                        ? date('d-m-Y', strtotime($profile->create_date)) 
                                        : null));
                                        ?>
                                    </td>
                                    ...
                                    <b><?php if($tretment->e_o) { ?> </b><?php echo 'E/O: '.$temp_1." - ".$temp_2;?> <?php }?><br><br>
                                     ...
                                     <?php if($profile->department_id != 32){ ?>BP : <br><?php } ?>
                                     Pluse : <br>
                                     नाडी  : <br>
                                     उर (rs) :<br>
                                     CVS  : <br>
	           ...
	           $nidra[$nidra1];
                            ...
                            <tbody>
                                  ...
                                  <tr>
                                    ...
                                    ?>
                                    <b><?php if($tretment->e_o) { ?> </b> <?php }?><br><br>
