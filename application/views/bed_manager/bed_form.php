                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9"> 
                                <div class="form-check">
                                    <label class="radio-inline"><input type="radio" name="status" value="1" <?php echo ($bed->status ?? 1) == 1 ? 'checked' : '' ?>><?php echo display('active') ?></label>
                                    <label class="radio-inline"><input type="radio" name="status" value="0" <?php echo ($bed->status ?? 1) == 0 ? 'checked' : '' ?>><?php echo display('inactive') ?></label>
                                </div>
                            </div>
                        </div>
