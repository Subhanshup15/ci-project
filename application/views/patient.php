                              ...
                              if($_GET['start_date']){
                                $dd1=date('Y-m-d', strtotime($_GET['start_date']));
                                 ...
                                 $dd1=date('Y-m-d');
                                    ...
                                    if(($patient->sex=='M') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28' || $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth <= 5))
                                    {$patient->discharge_date; if($dd != $dd1)
                                    {$five_all_mn++;} else{}}
                                 if(($patient->sex=='M') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->old_reg_no) && ($patient->date_of_birth <= 5)){
                                   $five_all_mo++;}
                                 if(($patient->sex=='F') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28' || $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth <= 5))
                                 {if($dd != $dd1){$five_all_fn++; } else{} }
                                 if(($patient->sex=='F') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28' || $patient->department_id =='27') && ($patient->old_reg_no) && ($patient->date_of_birth <= 5))
                                 {if($dd != $dd1){$five_all_fo++;} else{}}
                                  ...
                                  if(($patient->sex=='M') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 6 && $patient->date_of_birth <= 15)){
                                     $patient->discharge_date;if($dd != $dd1){$five_sixteen_all_mn++;} else{}}
                                 if(($patient->sex=='M') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->old_reg_no) && ($patient->date_of_birth >= 6 && $patient->date_of_birth <= 15))
                                 {$five_sixteen_all_mo++;}
                                 if(($patient->sex=='F') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 6 && $patient->date_of_birth <= 15)){
                                 if($dd != $dd1){$five_sixteen_all_fn++;} else{}}
                                 if(($patient->sex=='F') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28' || $patient->department_id =='27') && ($patient->old_reg_no) && ($patient->date_of_birth >= 6 && $patient->date_of_birth <= 15)){
                                 if($dd != $dd1){ $five_sixteen_all_fo++; } else{}}
                                  ...
                                  if(($patient->sex=='M')  && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 16 && $patient->date_of_birth <= 45)){
                                     $patient->discharge_date; 
                                     if($dd != $dd1){$sixteen_fourtyfive_all_mn++; } else{} }
                                 if(($patient->sex=='M') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->old_reg_no) && ($patient->date_of_birth >= 16 && $patient->date_of_birth <= 45)){
                                    $sixteen_fourtyfive_all_mo++; }
                                 if(($patient->sex=='F') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 16 && $patient->date_of_birth <= 45)){
                                 ...
                                 if(($patient->sex=='M') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 46 && $patient->date_of_birth <= 60)){
                                 ...
                                 if(($patient->sex=='F') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 46 && $patient->date_of_birth <= 60)){
                                 ...
                                 if(($patient->sex=='F') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->old_reg_no) && ($patient->date_of_birth >= 46 && $patient->date_of_birth <= 60)){
                                   ...
                                   if(($patient->sex=='M') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 61)){
                                     $patient->discharge_date; if($dd != $dd1){ $sixty_above_all_mn++; } else{} }
                                 if(($patient->sex=='M') && ($$patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->old_reg_no) && ($patient->date_of_birth >= 61)){
                                    $sixty_above_all_mo++; 
                                     
                                 }
                                 if(($patient->sex=='F') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 61)){
                                     if($dd != $dd1){
                                    $sixty_above_all_fn++; 
                                     } else{}
                                     
                                 }
                                 if(($patient->sex=='F') && ($patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28'|| $patient->department_id =='27') && ($patient->old_reg_no) && ($patient->date_of_birth >= 61)){
                                        if($dd != $dd1){
                                    $sixty_above_all_fo++; 
                                        } else{}
            ...
            <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                             ...
                             <th style="width: 30px;" >VISHCHIKITSA</th>
                    ...
                    <tbody>
                        ...
                        <!--  <td><?php echo $a=$at_tt + $at_ttdn - $at_ttan; ?></td>-->
                             ...
                             <td><?php echo $vs= $vs_tt + $vs_ttdn - $vs_ttan; ?></td> 
                             <td><?php echo $t_t= $A  + $k + $p + $b + $sl + $sk + $s +$vs; ?></td> 
                        </tr>
                        <tr>                
                          ...
                          <!-- <td><?php echo $at_ttdn; ?></td> -->
                             ...
                             <td><?php echo $vs_ttdn; ?></td> 
                             <td><?php echo  $t_d=$ky_ttdn + $pn_ttdn + $ba_ttdn + $sly_ttdn + $sky_ttdn + $st_ttdn + $vs_ttdn;?></td> 
                        </tr>
                        <tr>                
                             <td>TOTAL</td> 
                        ...
                        <tr>                
                         ...
                         <!-- <td><?php echo $at_ttan; ?></td>  -->
                             ...
                             <td><?php echo $vs_ttan; ?></td> 
                             <td><?php echo  $t_a= $ky_ttan + $pn_ttan + $ba_ttan + $sly_ttan + $sky_ttan + $st_ttan + $vs_ttan;  ?></td> 
                        </tr>
                        <tr>                
                           
                             <td>GRAND TOTAL</td> 
                          <!--<td><?php echo ($a + $at_ttan) - $at_ttdn; ?></td>   -->
                             ...
                             <td><?php echo ($s + $st_ttan) - $st_ttdn; ?></td> 
                              <td><?php echo ($vs + $vs_ttan) - $vs_ttdn; ?></td> 
