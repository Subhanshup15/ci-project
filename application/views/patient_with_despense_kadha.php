...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php  echo base_url('stock/daily_dispense_patient_report'); ?>">
        ...
        <div class="panel-body" style="font-size: 11px;">
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                    ...
                    <td><?php echo $pt->RX1; ?></td>
                  	<td><?php echo $pt->RX1_despense; ?></td>
                </tr>
              <?php } ?>
