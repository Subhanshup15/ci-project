...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/getpatientby_investigation_date_testwise'); ?>">
        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="col-sm-12">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
                          ...
                          if($department_id){
			               ...
			               $name= $dept_name->name;
                               ...
                               $ipd = ($patients[0]->ipd_opd);
                                ...
                                if($ipd == 'ipd'){ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php if($name) { echo "Departmental ";} else {echo "Date";} ?> Wise Investigation  (IPD)<?php if($name=='Swasthrakshnam'){ echo "(".$name." -KC)";} elseif($name){ echo"(".$name.")" ; }?></h3>
                    ...
                    <?php }else{ ?>
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php if($name) { echo "Departmental ";} else {echo "Date Wise Investigation (OPD)";}?>  <?php  if($name) {echo "(".$name.")";}?></h3>
                        <h4 style="margin-top: 0px; margin-bottom: 15px;">Start Date:-  <?php echo date("d/m/Y", strtotime($datefrom))  ?>   To  <?php echo date("d/m/Y", strtotime($dateto)) ?> </h4>
                     <?php  }  ?>
...
?>
                            <?php  $array_patho1= array(); $array_patho2= array(); $array_patho3= array(); 
                                 ...
                                 $HEMATOLOGICALTestCount = 0;
                                 $SEROLOGYCALTestCount=0;
                                 $BIOCHEMICALTestCount=0;
                                 $MICROBIOLOGICALTestCount=0;
                                /* $X_RAYTestCount=0;
                                 $ECGTestCount = 0;
                                 $USGTestCount = 0;*/
                                ...
                                <?php if(($HEMATOLOGICAL !='') || ($SEROLOGYCAL !='') || ($BIOCHEMICAL !='') || ($MICROBIOLOGICAL !='') || ($X_RAY !='') || ($ECG !='')) {?><tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else { echo ""; } ?>">
			                       ...
			                       ->where('department_id', $patient->department_id) 
                                    ...
                                    if($ipd == 'ipd'){ echo $doctor_name->firstname;} else { echo date('Y-m-d',strtotime($patient->create_date));}?></td><?php } ?>
                                     ...
                                     <?php if($department_by =='dpt') {?> 
                                        <td  style="padding:2px;"><?php echo $HEMATOLOGICAL; ?></td> 
                                        <?php 
                                            $ex = explode(',',trim($HEMATOLOGICAL));
                                            if($ex[0]!='' || $ex[0]!=null){
                                                // print_r($ex);
                                                // print_r(count($ex));
                                                // echo '<br>';
                                                $HEMATOLOGICALTestCount = $HEMATOLOGICALTestCount + count($ex);
                                            }
                                        ?>
                                     <?php } ?> 
                                     <?php if($department_by =='dpt') {?> 
                                        <td  style="padding:2px;"><?php echo $SEROLOGYCAL; ?></td> 
                                        <?php 
                                            $ex = explode(',',trim($SEROLOGYCAL));
                                            if($ex[0]!='' || $ex[0]!=null){
                                                // print_r($ex);
                                                // print_r(count($ex));
                                                // echo '<br>';
                                                $SEROLOGYCALTestCount = $SEROLOGYCALTestCount + count($ex);
                                            }
                                        ?>
                                    <?php } ?> 
                                     <?php if($department_by =='dpt') {?> 
                                        <td  style="padding:2px;"><?php echo $BIOCHEMICAL; ?></td> 
                                        <?php 
                                            $ex = explode(',',trim($BIOCHEMICAL));
                                            if($ex[0]!='' || $ex[0]!=null){
                                                // print_r($ex);
                                                // print_r(count($ex));
                                                // echo '<br>';
                                                $BIOCHEMICALTestCount = $BIOCHEMICALTestCount + count($ex);
                                            }
                                        ?>
                                    <?php } ?> 
                                     <?php if($department_by =='dpt') {?> 
                                        <td  style="padding:2px;"><?php echo $MICROBIOLOGICAL; ?></td> 
                                        <?php 
                                            $ex = explode(',',trim($MICROBIOLOGICAL));
                                            if($ex[0]!='' || $ex[0]!=null){
                                                // print_r($ex);
                                                // print_r(count($ex));
                                                // echo '<br>';
                                                $MICROBIOLOGICALTestCount = $MICROBIOLOGICALTestCount + count($ex);
                                            }
                                        ?>
                                    <?php } ?> 
                                    <!-- <?php if($department_by =='dpt') {?> 
                                        <td  style="padding:2px;"><?php if($X_RAY) { echo $X_RAY; }?></td>
                                        <?php 
                                            $ex = explode(',',trim($X_RAY));
                                            if($ex[0]!='' || $ex[0]!=null){
                                                // print_r($ex);
                                                // print_r(count($ex));
                                                // echo '<br>';
                                                //$X_RAYTestCount = $X_RAYTestCount + count($ex);
                                            }
                                        ?>
                                    <?php }?> 
                                     <?php if($department_by =='dpt') {?> 
                                        <td  style="padding:2px;"><?php if($ECG) { echo  $ECG;  } ?></td>  
                                        <?php 
                                            $ex = explode(',',trim($ECG));
                                            if($ex[0]!='' || $ex[0]!=null){
                                                // print_r($ex);
                                                // print_r(count($ex));
                                                // echo '<br>';
                                               // $ECGTestCount = $ECGTestCount + count($ex);
                                            }
                                        ?>
                                    <?php }?> 
                                     <?php if($department_by =='dpt') {?> 
                                        <td  style="padding:2px;"><?php if($USG) { echo  $USG; } ?></td> 
                                         <?php 
                                            $ex = explode(',',trim($USG));
                                            if($ex[0]!='' || $ex[0]!=null){
                                                // print_r($ex);
                                                // print_r(count($ex));
                                                // echo '<br>';
                                               // $USGTestCount = $USGTestCount + count($ex);
                                            }
                                        ?>
                                    <?php }?> 
                                    -->
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    ...
                                    <td><?php /*echo $HEMATOLOGICAL1;*/ echo $HEMATOLOGICALTestCount; ?></td>
                                </tr>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "2";?> </td>
                                    <td><?php echo "SEROLOGYCAL"; ?></td> <!-- //patient_id yearly sr no -->
                                    <td><?php echo /*$SEROLOGYCAL1;*/ $SEROLOGYCALTestCount; ?></td>
                                </tr>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "3";?> </td>
                                    <td><?php echo "BIOCHEMICAL"; ?></td> <!-- //patient_id yearly sr no -->
                                    <td><?php echo /*$BIOCHEMICAL1;*/ $BIOCHEMICALTestCount; ?></td>
                                </tr>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "4";?> </td>
                                    <td><?php echo "MICROBIOLOGICAL"; ?></td> <!-- //patient_id yearly sr no -->
                                    <td><?php echo /*$MICROBIOLOGICAL1;*/ $MICROBIOLOGICALTestCount; ?></td>
                                </tr>
                                
                                 <!--<tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "5";?> </td>
                                    <td><?php echo "X-RAY"; ?></td> <!-- //patient_id yearly sr no -
                                    <td><?//php echo /*$X_RAY1;*/ $X_RAYTestCount; ?></td>
                                </tr>-->
                                <!--<tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "6";?> </td>
                                    <td><?php echo "ECG"; ?></td> <!-- //patient_id yearly sr no 
                                    <td><?//php echo /*$ECG1;*/ $ECGTestCount; ?></td>
                                </tr>
                                  <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td><?php echo "7";?> </td>
                                    <td><?php echo "USG"; ?></td> <!-- //patient_id yearly sr no 
                                    <td><?//php echo /*$USG1;*/ $USGTestCount; ?></td>
                                </tr>-->
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">                                   
                                    <td></td>
                                    <td><?php echo "TOTAL"; ?></td> <!-- //patient_id yearly sr no -->
                                    <td><?php echo $HEMATOLOGICALTestCount + $SEROLOGYCALTestCount + $BIOCHEMICALTestCount + $MICROBIOLOGICALTestCount; ?></td>
                                </tr>
