...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/getInvestigation_register_usg/'.$section); ?>">
        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-body" style="font-size:<?php if($patients[0]->ipd_opd =='ipd'){ echo "9px";} else { echo "11px"; }?> ;">
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    ...
                    <tbody>
                       <?php foreach($investiUSGResult as $key => $pr){ ?>
                            <?php 
                                if($section == 'opd'){
                            ...
                            <tr>
                                ...
                                <td><?php echo ++$investiUSGResultYearlyCount; ?></td>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $tot_array=array($investiUSGResultCount->usgCount);
                        ?> 
                        <?php $n = 1; ?>
