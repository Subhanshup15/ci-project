<div class="row">
    <!--  table area -->
    <div class="col-sm-12">
        <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('stock/daily_dispense_report_tab'); ?>">
        ...
        <div  class="panel panel-default thumbnail">
          ...
          <div class="row">
            ...
            <table class="table table-bordered table-striped table-hover">
             ...
             <div class="col-sm-12" align="center">
                                <h2 style="margin-bottom: 15px;"><strong><?php echo "Tablet Medicine Register"; ?></strong></h2>
                            </div>
            <table class="table table-bordered table-striped table-hover">
