        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-body panel-form">
                ...
                <div class="row">
                        ...
                        <?php echo form_open('department/deprt_aatya','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <label for="name" class="col-xs-3 col-form-label">Set Department Aatya Limit<i class="text-danger">*</i></label>
