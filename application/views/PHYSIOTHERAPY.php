...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php  echo base_url('patients/patient_by_date_p'); ?>">
        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="col-sm-12" align="center">  
                  <strong><?php echo $this->session->userdata('title') ?></strong>
			                ...
			                ->row();
			                 ...
			                 $dept_name= $dept_name->name;
                               ...
                               $dept_name ='';
                                ...
                                if($ipd == 'ipd'){ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php if($name) { echo "Departmental ";} elseif($gob=='gob'){ echo "GOB"; } else { echo "PHYSIOTHERAPY IPD Report";} ?>   <?php if($name=='Swasthrakshnam'){ echo "(".$name." -KC)";} elseif($name){ echo"(".$name.")" ; } elseif($dept_name){ echo"(".$dept_name.")" ;}?></h3>
                    ...
                    <?php }else{ ?>
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php if($name) { echo "Departmental ";} else { echo "PHYSIOTHERAPY OPD Register"; }?>  <?php  if($name) { echo "(".$name.")";}?></h3>
                        <h4 style="margin-top: 0px; margin-bottom: 15px;">Start Date:-  <?php echo date("d/m/Y", strtotime($datefrom))  ?>   To  <?php echo date("d/m/Y", strtotime($dateto)) ?> </h4>
                     <?php  }  ?>
                         ...
                         <?php } } } ?>
                          <lable style="float: right;">Doctor Name: <?php echo"<span style='font-weight: 600;'>Dr. Ashwarya Anil Vedpathak </span>"; ?></lable>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" <?php  if($gob=='gob') { echo "style='font-size:10px;'";}?> style="display:  <?php  if($summery_report =='1') { echo "none";}?>">
                    <thead>
                        <tr>
                            ...
                            <th  <?php  if($gob=='gob') { echo "style='width:1px;'";}?> rowspan="2" style="width: 100px;"><?php echo display('sex') ?></th>   
                            <th  <?php  if($gob=='gob') { echo "style='width:1px;'";}?> rowspan="2" style="width: 100px;"><?php echo "Age" ?></th>                  
                           ...
                           <th style="width: 60px;" rowspan="2"><?php echo "PHYSIOTHERAPY"?></th> 
                           

                           
                            
                            <th class="no-print" rowspan="2" style="width: 100px;"><?php echo display('action') ?></th> 
                             ...
                             $dd12=date('Y-m-d', strtotime($_GET['end_date']));
                              if($_GET['end_date']){
                                ...
                                // for same ipd diagnosis treatment is not avaible    
			                      ...
			                      $PHYSIOTHERAPY= $tretment->PHYSIOTHERAPY;
                              ...
                              ?>
                               <?php //if(($RX3=='CHEST PHYSIOTHERAPY - PH') || ($RX3='ULTRA SOUND EXERSIZE -PH') || ($RX3=='STIMULATION                         EXERSIZE -PH') || ($RX3=='TENS  IFT                                    EXERSIZE - PH') || ($RX3=='ULTRA SOUND  -PH') || ($RX3=='EXERSIZE -PH')){
                                /*$word = "PH";
                              $mystring = $RX3;
                                $p_day= date("l",strtotime($datefrom));
                                $day = date("D",strtotime($datefrom));
                              if((strpos($mystring, $word) !== false)){
                                  if($day=='Mon' || $p_day=='Thu'){
                                      if($PHYSIOTHERAPY != '' || $PHYSIOTHERAPY != null){
                                  $k++;*/
                                  if($PHYSIOTHERAPY != '' || $PHYSIOTHERAPY != null){
                               ?>
                                 ...
                                 <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else if(($New_OPD ==$patient->yearly_reg_no) && ($old_OPD == $patient->old_reg_no) && ($ipd == 'opd')){ echo "color: #ff000d;font-weight: bold;"; } else { echo ""; } ?>">
                                    ...
                                    <?php } else {?>
                                    <td style="padding:2px;"><?php echo $tot_serial1_d++; ?></td><?php }?>
                                    ...
                                    <td><?php echo date('Y-m-d',strtotime($patient->create_date)); ?></td> 
                                     ...
                                     <?php if($department_by !='dpt'){ ?> <td  style="padding:2px;"><?php echo $patient->name; ?></td> <?php } ?>
                                      ...
                                      <td  style="padding:2px;"><?php echo $PHYSIOTHERAPY; ?></td>  
