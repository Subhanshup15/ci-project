...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php  echo base_url('patients/getpatientbydepartment_date_sky1'); ?>">
                    ...
                    <thead>
                        <tr>
                           ...
                           <th rowspan="2" style="width: 30px;"><?php echo "Date"; ?></th>
                            ...
                            <?php  if($ipd == 'opd'){ ?>  <th colspan="2" style="width: 10px;"><?php echo "Diagnosis"; ?></th> <?php } ?> 
                           ...
                           <?php if($department_by !='dpt'){ ?> <th style="width: 30px;" rowspan="2"><?php echo "Department" ?></th> <?php } ?>
                            ...
                            <?php if($ipd == 'ipd'){ ?><th rowspan="2" style="width: 30px;" ><?php echo "Sign. Of Incharge Sister" ?></th> <?php } ?>
...
?>
                            <?php $i = 0; 
                             $adt_mn=0;$adt_mo=0;$adt_fn=0;$adt_fo=0; $adt_tt=0; 
                              ...
                              if($_GET['start_date']){
                                $dd1=date('Y-m-d', strtotime($_GET['start_date']));
                                 ...
                                 $dd1=date('Y-m-d');
                                  ...
                                  if(($patient->sex=='M') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth <= 5))
                                    {$patient->discharge_date; if($dd != $dd1)
                                    {$five_all_mn++;} else{}}
                                 if(($patient->sex=='M') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->old_reg_no) && ($patient->date_of_birth <= 5)){
                                   $five_all_mo++;}
                                 if(($patient->sex=='F') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth <= 5))
                                 {if($dd != $dd1){$five_all_fn++; } else{} }
                                 if(($patient->sex=='F') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->old_reg_no) && ($patient->date_of_birth <= 5))
                                 {if($dd != $dd1){$five_all_fo++;} else{}}
                                  ...
                                  if(($patient->sex=='M') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 6 && $patient->date_of_birth <= 15)){
                                     $patient->discharge_date;if($dd != $dd1){$five_sixteen_all_mn++;} else{}}
                                 if(($patient->sex=='M') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->old_reg_no) && ($patient->date_of_birth >= 6 && $patient->date_of_birth <= 15))
                                 {$five_sixteen_all_mo++;}
                                 if(($patient->sex=='F') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 6 && $patient->date_of_birth <= 15)){
                                 if($dd != $dd1){$five_sixteen_all_fn++;} else{}}
                                 if(($patient->sex=='F') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->old_reg_no) && ($patient->date_of_birth >= 6 && $patient->date_of_birth <= 15)){
                                 if($dd != $dd1){ $five_sixteen_all_fo++; } else{}}
                                  ...
                                  if(($patient->sex=='M')  && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 16 && $patient->date_of_birth <= 45)){
                                     $patient->discharge_date; 
                                     if($dd != $dd1){$sixteen_fourtyfive_all_mn++; } else{} }
                                 if(($patient->sex=='M') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->old_reg_no) && ($patient->date_of_birth >= 16 && $patient->date_of_birth <= 45)){
                                    $sixteen_fourtyfive_all_mo++; }
                                 if(($patient->sex=='F') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 16 && $patient->date_of_birth <= 45)){
                                 ...
                                 if(($patient->sex=='M') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 46 && $patient->date_of_birth <= 60)){
                                     $patient->discharge_date; if($dd != $dd1){ $fourtyfive_sixty_all_mn++;} else{}}
                                 if(($patient->sex=='M') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->old_reg_no) && ($patient->date_of_birth >= 46 && $patient->date_of_birth <= 60)){
                                    $fourtyfive_sixty_all_mo++; }
                                 if(($patient->sex=='F') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 46 && $patient->date_of_birth <= 60)){
                                 ...
                                 if(($patient->sex=='F') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->old_reg_no) && ($patient->date_of_birth >= 46 && $patient->date_of_birth <= 60)){
                                   ...
                                   if(($patient->sex=='M') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 61)){
                                     $patient->discharge_date; if($dd != $dd1){ $sixty_above_all_mn++; } else{} }
                                 if(($patient->sex=='M') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->old_reg_no) && ($patient->date_of_birth >= 61)){
                                    $sixty_above_all_mo++; 
                                     
                                 }
                                 if(($patient->sex=='F') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->yearly_reg_no) && ($patient->date_of_birth >= 61)){
                                     if($dd != $dd1){
                                    $sixty_above_all_fn++; 
                                     } else{}
                                     
                                 }
                                 if(($patient->sex=='F') && ($patient->department_id =='36' || $patient->department_id =='35' || $patient->department_id =='34' || $patient->department_id =='33' || $patient->department_id =='32' || $patient->department_id =='31' || $patient->department_id =='30' || $patient->department_id =='29' || $patient->department_id =='28') && ($patient->old_reg_no) && ($patient->date_of_birth >= 61)){
                                        if($dd != $dd1){
                                    $sixty_above_all_fo++; 
                                        } else{}
                            ...
                            //atya
                              ...
                              ?>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else if(($New_OPD ==$patient->yearly_reg_no) && ($old_OPD == $patient->old_reg_no) && ($ipd == 'opd')){ echo "color: #ff000d;font-weight: bold;"; } else { echo ""; } ?>">
                                   ...
                                   <td style="padding:2px;"><?php if($ipd == 'ipd'){ echo $i;}else{echo $tot_serial1_d++; } ?></td>
                                    ...
                                    <?php if($ipd == 'ipd'){if($year122 == $this->session->userdata['acyear']){ ?>
                                        <td  style="padding:2px;"><?php  if($department_by_section=='ipd'){ echo $patient->ipd_no_new; } else{ echo $patient->ipd_no_new;  } ?></td> 
                                    <?php }else{ ?> 
                                        <td  style="padding:2px;"><?php  if($department_by_section=='ipd'){ echo $patient->ipd_no_new; }?></td>
                                    <?php  } } ?> 
                                    <?php 
                               ...
                               $yy=substr($y,2,2);
                                 ...
                                 <?php  if($ipd == 'opd'){ ?>  <td class="dignosis_name test"><?php if($skya =='N'){  echo $p_dignosis_name; }?></td> <?php }?>
                                  <?php  if($ipd == 'opd'){ ?>  <td class="dignosis_name test"><?php if($skya =='M'){ echo $p_dignosis_name; } ?></td> <?php }?>
                                    ...
                                    <td  style="padding:2px;"><?php  echo $doctor_name->firstname;?></td><?php } ?>
                                        ...
                                        <?php if($department_by =='dpt') {?>
                                                <td  style="padding:2px;<?php if($gob =='gob') { echo "font-size: 10px;";}?>">
                                                   ...
                                                   <?php if($other_equipment){ echo $other_equipment.', <br>'; }?>
                                        <?php }?>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                    <?php $n=1;
                              $male_new=array($adt_mn,$aa_mn,$ky_mn,$pn_mn,$ba_mn,$sly_mn,$sky_mn,$st_mn,$sw_mn);
                              $male_old=array($adt_mo,$aa_mo,$ky_mo,$pn_mo,$ba_mo,$sly_mo,$sky_mo,$st_mo,$sw_mo);

                              $female_new=array($adt_fn,$aa_fn,$ky_fn,$pn_fn,$ba_fn,$sly_fn,$sky_fn,$st_fn,$sw_fn);
                              $female_old=array($adt_fo,$aa_fo,$ky_fo,$pn_fo,$ba_fo,$sly_fo,$sky_fo,$st_fo,$sw_fo);

                              $total=array($adt_tt,$aa_tt,$ky_tt,$pn_tt,$ba_tt,$sly_tt,$sky_tt,$st_tt,$sw_tt);
    ...
    <tbody>
        <tr>
            <td>1</td>
            <td>Shalakyatantra</td>
            <td><?php echo $total_netra = $sky_netra_m_n + $sky_netra_m_o + $sky_netra_f_n + $sky_netra_f_o; ?></td>
            <td><?php echo $total_ent = $sky_mukha_m_n + $sky_mukha_m_o + $sky_mukha_f_n + $sky_mukha_f_o; ?></td>
        </tr>
        <tr>
            <td colspan="2">Grand Total</td>
            <td colspan="2" style="text-align: center;"><?php echo $total_netra + $total_ent; ?></td>
        </tr>
    </tbody>
</table>
