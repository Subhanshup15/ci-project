...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/getpatientby_investigation_date_xay'); ?>">
            ...
            <div class="col-sm-12">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
                    ...
                    <?php   
                        ...
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php echo "X-RAY REGISTER"; ?></h3>
                        ...
                        <tr>
                          ...
                          <!-- <?php if($department_by =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php  echo "USG";?></th> <?php }?> -->
                            ...
                            <?php   
                              ...
                              <?php  }  ?>
                            <th class="no-print" rowspan="2" style="width:60px;"><?php echo display('action') ?></th> 
...
?>
                            <?php  $array_patho1= array(); $array_patho2= array(); $array_patho3= array(); 
                              ...
                              ?>
                                ...
                                <?php if($X_RAY !='') {?><tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else { echo ""; } ?>">
                                    <td style="padding:2px;"><?php if($X_RAY !='') { echo $Sr_no++ ;} else{ echo $Sr_no++; } ?></td>
