...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/getpatientbydepartment_karma_date_other'); ?>">
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    <thead>
                        <tr>
                           ...
                           <?php if($department_by =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php  echo "UTTARBASTI"; ?></th> <?php }?>
                           <?php if($department_by  =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php  echo "YONIDHAVAN"; ?></th> <?php }?>  
                           <?php if($department_by =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php  echo "YONIPICHU"; ?></th> <?php }?>
...
?>
                            ...
                            <?php $i = 1; $n=1;
                                $UTTARBASTI1=0; $YONIDHAVAN1=0; $YONIPICHU1=0;
                            ...
                            //          }
                              ...
                              ?>
                                 ...
                                 <?php if($department_by =='dpt') { if(($UTTARBASTI !='') || ($YONIDHAVAN !='') || ($YONIPICHU !='') ) { ?><tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else { echo ""; } ?>">
			                       ...
			                       //print_r($import);
                                    ...
                                    <?php 
                                    $dept_id = $this->db->select("*")
                                    ->from('department')
                                    ->where('dprt_id',$patient->department_id)
                                    ->get()
                                    ->row();
                                    ?> 
                                  <?php if($department_by =='dpt'){ ?> <td  style="padding:2px;"><?php echo $dept_id->name; ?></td> <?php } ?>
			                       ...
			                       ->where('department_id', $patient->department_id) 
                                    ...
                                    if($ipd == 'ipd'){ echo $doctor_name->firstname;} else { echo date('Y-m-d',strtotime($patient->create_date));}?></td><?php } ?>
                                     ...
                                     <?php if($department_by =='dpt') {?> <td  style="padding:2px;"><?php echo $UTTARBASTI; ?></td> <?php } ?>  
                                      
                                       <?php if($department_by =='dpt') {?> <td  style="padding:2px;"><?php echo $YONIDHAVAN;  ?></td>  <?php }?>
                                       <?php if($department_by =='dpt') {?> <td  style="padding:2px;"><?php echo $YONIPICHU; ?></td>  <?php }?> 
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                            ...
                            if($years=='2020'){
                            $tot_array=array($UTTARBASTI1,$YONIDHAVAN1,$YONIPICHU1);
                            }else{
                            $tot_array=array($UTTARBASTI1,$YONIDHAVAN1,$YONIPICHU1);
                            }
?> 
