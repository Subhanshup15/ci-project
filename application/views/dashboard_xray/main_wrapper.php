    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <header class="main-header"> 
                ...
                <a href="<?php echo base_url('dashboard_xray/home') ?>" class="logo"> <!-- Logo -->
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo base_url('dashboard_xray/home/profile'); ?>"><i class="pe-7s-users"></i> <?php echo display('profile') ?></a></li>

                                    <li><a href="<?php echo base_url('dashboard_xray/home/form'); ?>"><i class="pe-7s-settings"></i> <?php echo display('edit_profile') ?></a></li>

                                    <li><a href="<?php echo base_url('dashboard_xray/home/logout') ?>"><i class="pe-7s-key"></i> <?php echo display('logout') ?></a></li>
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="<?php echo (($this->uri->segment(2) == 'home') ? "active" : null) ?>">
                            ...
                            <a href="<?php echo base_url('dashboard_xray/home') ?>"><i class="fa ti-home"></i> <?php echo display('dashboard') ?></a>

                        </li> 



                        <li class="treeview" <?php echo (($this->uri->segment(2) == "laboratory") ? "active" : null) ?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_xray/xray/xray/create") ?>">Add Xray Report</a></li>
                                <li><a href="<?php echo base_url("dashboard_xray/xray/xray") ?>">Xray</a></li>
                        ...
                        <li class="<?php echo (($this->uri->segment(2) == 'noticeboard') ? "active" : null) ?>">
                            ...
                            <a href="<?php echo base_url('dashboard_xray/noticeboard/notice') ?>"><i class="fa fa-bell"></i> <?php echo display('noticeboard') ?></a>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "messages") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url("dashboard_xray/messages/message/new_message") ?>"> <?php echo display('new_message') ?> </a></li> 

                                <li><a href="<?php echo base_url("dashboard_xray/messages/message") ?>"> <?php echo display('inbox') ?> </a></li> 

                                <li><a href="<?php echo base_url("dashboard_xray/messages/message/sent") ?>"><?php echo display('sent') ?> </a></li>
                        ...
                        <li class="<?php echo (($this->uri->segment(2) == 'mail') ? "active" : null) ?>">
                            ...
                            <a href="<?php echo base_url('dashboard_xray/mail/email') ?>"><i class="fa ti-email"></i> <?php echo display('send_mail') ?></a>
