   ...
   <div class="col-sm-12">
      <div  class="panel panel-default thumbnail">
         <div class="panel-heading no-print">
            <div class="btn-group"> 
               <a class="btn btn-primary" href="<?php echo base_url("dashboard_laboratorist/lab/laboratory") ?>"> <i class="fa fa-list"></i>  laboratory list </a>  
            </div>
         </div>
         <div class="panel-body panel-form">
            <?php echo form_open_multipart('dashboard_laboratorist/lab/laboratory/create','class="form-inner"') ?>
            <?php echo form_hidden('id',$lab->id); ?>        
               ...
               <div class="col-md-6 col-sm-12">               
                ...
                <div class="row panel-body panel-form">
                    <div class="col-md-4">
                        <div class="form-group row">
                            <label for="hb" class="col-xs-5 col-form-label">hb</label>
                            <div class="col-xs-7">
                                <input name="hb" autocomplete="off" type="text" class="form-control" id="hb" placeholder="hb" value="<?php echo $lab->hb ?>">    
                            </div>
                        </div>
