                            ...
                            <?php foreach ($notices as $notice) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a href="<?php echo base_url("dashboard_xray/noticeboard/notice/details/$notice->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                            ...
                            <?php foreach ($messages as $message) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        ...
                                        <a href="<?php echo base_url("dashboard_xray/messages/message/inbox_information/$message->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 

                                        <a href="<?php echo base_url("dashboard_xray/messages/message/delete/$message->id/$message->sender_id/$message->receiver_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
