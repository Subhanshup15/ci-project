...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/admitpatientdate'); ?>">
...
<!-- //Discharge Date -->
                    ...
                    <script>
						...
						function excel_all_customer(date1,date2,section){ 
						   // alert(date1);
	   //alert(date1+" "+date2);
		window.location='excel_all_customer_admit?date1='+date1+'&date2='+date2+'&section='+section;
