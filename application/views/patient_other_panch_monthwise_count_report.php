    ...
    <div class="panel panel-default thumbnail" style='border: none;'>
        ...
        <div class="panel-body" style="font-size: 11px;">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
                ...
                <?php if($section == 'ipd'){ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"> IPD Other Panchkarma Month Wise Summery Count Register</h3>
                ...
                <?php }else{ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"> OPD Other Panchkarma Month Wise Summery Count Register</h3>
                    <h4 style="margin-top: 0px; margin-bottom: 15px;">Start Date:-  <?php echo date("d/m/Y", strtotime($datefrom))  ?>   To  <?php echo date("d/m/Y", strtotime($dateto)) ?> </h4>
                <?php  }  ?>
            </div>
            ...
            <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php 
                            $panchkarma_item = array( 'uttarbastiCount' => 'UTTARBASTI', 'yonidhavanCount' => 'YONIDHAVAN', 'yonipichuCount' => 'YONIPICHU'); 
                            $i = 0;
                        ?>
                        <?php 
