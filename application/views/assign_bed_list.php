...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/getbedlist_date');  ?>">
                          ...
                          if($department_id){
			               ...
			               $name= $dept_name->name;
                               ...
                               $ipd = ($patients[0]->ipd_opd);
                                ...
                                if($ipd == 'ipd'){ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php echo "Assigned Bed List";?></h3>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>                
                           ...
                           <?php if($department_by =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php echo "RX1"?></th> <?php }?>  
                           <?php if($department_by  =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php echo "RX2"?></th> <?php }?>  
                           <?php if($department_by =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php echo "RX3"?></th> <?php }?> 
                             <?php if($department_by =='dpt') {?> <th style="width: 30px;" rowspan="2"><?php echo "Karm"?></th> <?php }?>  
                            ...
                            <?php $i = 0;  foreach ($patients as $patient) { $i++; 
                              ...
                              ?>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else { echo ""; } ?>">
                                    <td><?php if($ipd == 'ipd'){ echo $i;} else{ echo $tot_serial; } ?></td>
                                       
                                    <?php if($ipd == 'ipd'){ ?><td><?php  if($department_by_section=='ipd'){ echo $num_ipd--; } else{ echo $num_ipd++;} ?></td> <?php } ?>  
                                    ...
                                    <td><?php echo $patient->firstname; echo $patient->bedNo; ?></td>        
                                    <td><?php echo $patient->sex; ?></td>
                                    <td><?php 
                                    echo $patient->date_of_birth;   
                                    ?></td> 
                                    <!-- <td><?php echo $patient->address; ?></td>   -->
                                   <?php if($department_by !='dpt'){ ?> <td><?php echo $patient->name; ?></td> <?php } ?>
			                       ...
			                       ->where('department_id', $patient->department_id) 
                                    ...
                                    if($ipd == 'ipd'){ echo $doctor_name->firstname;} else { echo date('Y-m-d',strtotime($patient->create_date));}?></td><?php } ?>
                                     ...
                                     <?php if($department_by !='dpt') {?> <td></td> <?php } ?>  
                                      <?php if($department_by =='dpt') {?> <td></td> <?php }?>  
                                       <?php if($department_by =='dpt') {?> <td></td> <?php }?>  
                                        <?php if($department_by =='dpt') {?> <td></td> <?php }?> 
                                         <?php if($department_by =='dpt') {?> <td></td> <?php }?>  
