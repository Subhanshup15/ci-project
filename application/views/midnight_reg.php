...
<!---------------------------------------------------------       Fetch Record    --------------------------------------------------------------->                        
                        ...
                        <?php 
                            ...
                            $n=1;
                            $total=array($ky_tt,$pn_tt,$ba_tt,$sly_tt,$sky_tt,$st_tt,$sw_tt,$skym_tt,$vs_tt);
 ...
 <tr>
                     ...
                     <tr>
                        <td>5</td>
                        <td>Shalakyatantra M</td>
                        <td><?php echo $skm=$skym_tt + $skym_ttdn - $skym_ttan; ?></td>
                        <td><?php echo $skym_ttan; ?></td>
                        <td><?php echo $skym_ttdn; ?></td>
                        <td><?php echo ($skm + $skym_ttan) - $skym_ttdn; ?></td>
                    </tr>
                    <tr>
                        <td>6</td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><b><?php echo $t_t= $k + $p + $b + $sl + $sk + $s + $skm; ?></b></td>
                        <td><b><?php echo  $t_a=$ky_ttan + $pn_ttan + $ba_ttan + $sly_ttan + $sky_ttan + $st_ttan + $skym_ttan;  ?></b></td>
                        <td><b><?php echo  $t_d=$ky_ttdn + $pn_ttdn + $ba_ttdn + $sly_ttdn + $sky_ttdn + $st_ttdn + $skym_ttdn;?></b></td>
