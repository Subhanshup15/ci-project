    ...
    <div  class="panel panel-default thumbnail">
        ...
        <div class="panel-body" style="font-size: 11px;">
            ...
            <div class="col-sm-8" align="center">
                ...
                <?php if($section == 'ipd'){ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"> IPD X-Ray Summery Count Register</h3>
                ...
                <?php }else{ ?>
                    <h3 style="margin-top: 0px; margin-bottom: 15px;"> OPD X-Ray Summery Count Register</h3>
                    <h4 style="margin-top: 0px; margin-bottom: 15px;">Start Date:-  <?php echo date("d/m/Y", strtotime($datefrom))  ?>   To  <?php echo date("d/m/Y", strtotime($dateto)) ?> </h4>
                <?php  }  ?>
            </div>
