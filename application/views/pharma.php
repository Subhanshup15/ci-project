...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php  echo base_url('patients/pharma_date/'.$pharmas.'/'.$department_by_section.'/0');  ?>">
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" style="display: none;">
                    ...
                    <tr>
                       ...
                       <!-- <?php if($pharma[$i]->name=='LODHRA CHURNA'){?><td><?php echo $LODHRA1	;?></td><?php }
                        ...
                        elseif($pharma[$i]->name=='ASHWAGANDHA'){?><td><?php echo $ASHWAGANDHA1;?></td><?php }
                         elseif($pharma[$i]->name=='SITOPALADI CHURNA'){?><td><?php echo $SITOPALADI1;?></td><?php }
                          elseif($pharma[$i]->name=='GANDHARVAHAREETAKI CHURNA'){?><td><?php echo '';?></td><?php }
                           elseif($pharma[$i]->name=='BALA'){?><td><?php echo $BALA;?></td><?php }
                           elseif($pharma[$i]->name=='KIRAT TIKTA'){?><td><?php echo $KIRAT_TIKTA1	;?></td><?php }
                            elseif($pharma[$i]->name=='HINGVASHTAK CHURNA'){?><td><?php echo '';?></td><?php }
                        elseif($pharma[$i]->name=='AROGYAVARDHINI VATI'){?><td><?php echo '';?></td>
                        <?php } else{?>
                        <td></td>
                        <?php }?>
                        -->
                        ...
                        elseif($pharma[$i]->name=='TRIPHALA VATI'){?><td><?php if($TRIPHALA_VATI1=='0') { echo "-";} else {  echo $TRIPHALA_VATI1 * 20; echo " Tbs";}?></td><?php }
                       ...
                       elseif($pharma[$i]->name=='SAPTAMRUT LOHA GUTI'){?><td><?php if($SAPTAMRUT1=='0') { echo "-";} else {  echo $SAPTAMRUT1 * 20; echo " Tbs";}?></td><?php }
                        ...
                        elseif($pharma[$i]->name=='AAAAROGYAVARDHINI VATI1111'){?><td><?php if($AROGYAVARDHINI1=='0') { echo "-";} else {  echo $AROGYAVARDHINI1 * 10; echo " gm";}?></td>
                        <?php } else{?>
                        <td></td>
                        <?php } ?>
                      </tr>
