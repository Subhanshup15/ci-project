        ...
        <div  class="panel panel-default thumbnail">
            ...
            <!--<div class="panel-heading no-print">
                ...
                <div class="btn-group"> 
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url("department/Discharge_limit") ?>"> <i class="fa fa-list"></i> Data Limit</a>  
            ...
            <div class="panel-body panel-form">
                ...
                <div class="row">
                        ...
                        <?php echo form_open('department/Discharge_limit','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <label for="name" class="col-xs-3 col-form-label">Set Discharge Pateint Limit<i class="text-danger">*</i></label>
