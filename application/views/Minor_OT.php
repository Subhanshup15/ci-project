...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/minor_ot'); ?>">
            ...
            <div class="col-sm-12">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
                    ...
                    <?php   
                        ...
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php  echo "Minor Operation Theater Register";?></h3>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover" <?php  if($gob=='gob') { echo "style='font-size:10px;'";}?> style="display:  <?php  if($summery_report == 1) { echo "none";}?>">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 30px; text-align: center;" ><?php echo "Minor OT" ?></th>
...
?>
                            ...
                            //atya
                              ...
                              ?>
                                <?php if(stripos($patient->dignosis, 'VIDRADHI') !== false || 
                                        stripos($patient->dignosis, 'MEDOJ GRANTHI') !== false || 
                                        stripos($patient->dignosis, 'PTERYGIUM') !== false || 
                                        stripos($patient->dignosis, 'CHALAZION') !== false ||
                                        (stripos($patient->dignosis, 'ABSCESS') !== false && (trim($patient->dignosis) != 'PERIANAL ABSCESS - SLI'))){ 
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else if(($New_OPD ==$patient->yearly_reg_no) && ($old_OPD == $patient->old_reg_no) && ($ipd == 'opd')){ echo "color: #ff000d;font-weight: bold;"; } else { echo ""; } ?>">
                                    ...
                                    <td><?php if($patient->discharge_date == '0000-00-00'){ echo '00-00-0000';}else{echo date('d-m-Y',strtotime($patient->discharge_date));} ?></td>
                                     <td  style="padding:2px;">
                                        <?php
                                            if(stripos($patient->dignosis, 'VIDRADHI') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'MEDOJ GRANTHI') !== false){ echo $patient->dignosis; }
                                            elseif((stripos($patient->dignosis, 'ABSCESS') !== false) && (trim($patient->dignosis) != 'PERIANAL ABSCESS - SLI')){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'PTERYGIUM') !== false){ echo $patient->dignosis; }
                                            elseif(stripos($patient->dignosis, 'CHALAZION') !== false){ echo $patient->dignosis; }
                                        ?>
                                    </td> 
                                    <td style="width: 30px;"><?php echo $skarma;?></td> 
                                    <td style="width: 30px;"><?php echo $doctor_name->firstname;?></td> 
                               <!--   <td style="width: 30px;"><?php echo "Dr. Manoj Raut"; ?></td> -->
