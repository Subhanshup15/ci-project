   ...
   <div class="col-sm-12">
      <div  class="panel panel-default thumbnail">
         <div class="panel-heading no-print">
            <div class="btn-group"> 
               <a class="btn btn-primary" href="<?php echo base_url("laboratory/listseological1") ?>"> <i class="fa fa-list"></i> Laboratory list </a>  
            </div>
         </div>
         <div class="panel-body panel-form">
            <?php echo form_open_multipart('laboratory/seological1','class="form-inner"') ?>
            <?php echo form_hidden('id',$lab->id); ?>        
               ...
               <div class="form-group row">
                ...
                <div class="row panel-body panel-form" style="margin-left: 0px;">
                    <div class="col-md-6">
                        <!--
                        <div class="form-group row">
