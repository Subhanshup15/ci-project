...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php if($flag==1){ echo base_url('patients/getpatientbydepartment_gob_date'); } else if($department_by=='dpt') { echo base_url('patients/getpatientbydepartment_date'); } else { echo base_url('patients/patient_despensing_by_date'); }?>">
        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-body" style="font-size: 11px;">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
			                ...
			                ->row();
			                 ...
			                 $dept_name= $dept_name->name;
                               ...
                               $ipd = ($patients[0]->ipd_opd);
                                ...
                                if($ipd == 'ipd'){ ?>
                     <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php  echo "IPD Despensing Register"; ?></h3>
                    ...
                    <?php }else{ ?>
                        <h3 style="margin-top: 0px; margin-bottom: 15px;"><?php  echo "OPD Despensing Register";?></h3>         
                        <h4 style="margin-top: 0px; margin-bottom: 15px;">Start Date:-  <?php echo date("d/m/Y", strtotime($datefrom))  ?>   To  <?php echo date("d/m/Y", strtotime($dateto)) ?> </h4>
                     <?php  }  ?>
                    ...
                    <thead>
                        <tr>
                           ...
                           <?php if($department_by !='dpt'){ ?> <th style="width: 30px;" rowspan="2"><?php echo "Department" ?></th> <?php } ?>
                            ...
                            <?php if($department_by !='dpt') {?> <th style="width: 30px;" rowspan="2"><?php echo "Treatment";?></th><?php } ?> 
                           ...
                           <?php if($department_by =='dpt') {?> <th style="width: 60px; <?php if($gob =='gob') { echo "font-d: 10px;";}?>" rowspan="2"><?php echo "RX1"?></th> <?php }?>  
                            ...
                            //atya
                              ...
                              ?>
                               ...
                               $yy=substr($y,2,2);
                                 ...
                                 <?php $department_name = $this->db->where('dprt_id',$patient->department_id)->get('department')->row(); ?>
                                   <?php if($department_by !='dpt'){ ?> <td  style="padding:2px;"><?php echo $department_name->name; ?></td> <?php } ?>
                                    
									<?php if($department_by !='dpt') {?> <td  style="padding:2px;"><?php echo $RX1.'<br>'.$RX2.'<br>'.$RX3;?></td> <?php } ?>
