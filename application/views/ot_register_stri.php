...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/ot_register_stri_new_111'); ?>">
           ...
           <div class="col-sm-12">
             ...
             <h4 style="margin-top: 5px;margin-bottom: 5px;"><p class="text-center"><?php echo $this->session->userdata('address') ?></p></h4>
                    ...
                    <?php   
                        ...
                        <h3 style="margin-top: 0px; margin-bottom: 15px;">OT Register (Strirog)</h3>
                ...
                <div class="ccol-xs-2"></div></div></div>
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style="width: 250px;"><?php echo "Name" ?></th> 
                             
                            <th style="width: 30px;" rowspan="2"><?php echo "Age" ?></th>         
                           
                            <th style="width: 30px;" rowspan="2"><?php echo "Address" ?></th>
                           
							<th style="width: 200px;" rowspan="2"><?php echo "Dignosis" ?></th>
							<th style="width: 200px;" rowspan="2">Date</th> 
                            <th style="width: 200px;" rowspan="2">OT Date</th> 
                             <th style="width: 200px;" rowspan="2">Discharge Date</th> 
                            <th rowspan="2">Doctor</th>
                            <!--<th style="width: 100px;" rowspan="2"><?php echo "Investigation"?></th>-->
                            ...
                            <?php  $array_patho1= array(); $array_patho2= array(); $array_patho3= array(); 
								  ...
								  $USG= $tretment->USG;
								   ...
								   if(!empty($patient->department_id)){
                                    ...
                                    ->from('user')
			                        ->where('department_id', $patient->department_id)
			                        ->where('join_date<=', date("Y-m-d", strtotime($datefrom1)))
			                        ->where('Reliving_date>=', date("Y-m-d", strtotime($datefrom1)))
                                    ->get()
                                    ->row();
                                    //print_r($this->db->last_query());
                                    //die();
                              ...
                              ?>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else { echo ""; } ?>">
                                    ...
                                    <td  style="padding:2px;"><?php echo $patient->date_of_birth; ?></td>
                                     ...
                                     <?php
                                     if($patient->ftnd_lscs == 'LSCS') 
                                     {
                                        $ftnd = '('.$patient->ftnd_lscs.')';
                                     }
                                     else
                                     {
                                        $ftnd = '';
                                      ...
                                      ?> 
									 <td  style="padding:2px;"><?php echo $patient->dignosis.$ftnd; ?></td>
									  <td style="padding:2px;"><?php echo date('d-m-Y',strtotime($patient->create_date)); ?></td>
                                      <td style="padding:2px;">
                                      <?php
                                        if($patient->OT_date){ echo date('d-m-Y',strtotime($patient->OT_date));}
                                        echo "<br>";
                                        if($patient->OT_date1){ echo date('d-m-Y',strtotime($patient->OT_date1)); }
                                        echo "<br>";
                                        if($patient->OT_date2){ echo date('d-m-Y',strtotime($patient->OT_date2)); }
                                       ?>
                                       </td>
                                      <td style="padding:2px;"><?php echo date('d-m-Y',strtotime($patient->discharge_date)); ?></td>
                                    ...
                                    <td class="center no-print"  style="padding:2px;">
                                        <?php 
                                            ...
                                            <?php }else { ?>
                                                ...
                                                <a href="<?php echo base_url("patients/profile_anc/$patient->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>      
                                            <?php } ?>
