        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-body panel-form">
                ...
                <div class="row">
                        ...
                        <?php echo form_open('department/deprt_shalakya','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <label for="name" class="col-xs-3 col-form-label">Set Department Shalakya Limit<i class="text-danger">*</i></label>
