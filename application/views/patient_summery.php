...
<form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/patient_summery');?>">
...
?>
                            ...
                            // $at_mn=0;$at_mo=0;$at_fn=0;$at_fo=0; $at_tt=0; $at_ttn=0; $at_ttan=0; $at_ttdn=0; 
                             ...
                             $vi_mn=0;$vi_mo=0;$vi_fn=0;$vi_fo=0; $vi_tt=0; $vi_ttn=0; $vi_ttan=0; $vi_ttdn=0;
                              ...
                              ?>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="  <?php if(($date_c==$date_f) && ($ipd == 'ipd')){ echo "color: #ff000d;font-weight: bold;"; } else if(($date_d==$date_f) && ($ipd == 'ipd')) { echo "color: #4dd208;font-weight: bold;" ;} else if(($New_OPD ==$patient->yearly_reg_no) && ($old_OPD == $patient->old_reg_no) && ($ipd == 'opd')){ echo "color: #ff000d;font-weight: bold;"; } else { echo ""; } ?>">
                                   ...
                                   <?php
                                    ...
                                    <td style="padding:2px;">
                                    	<?php if($HEMATOLOGICAL){ echo $HEMATOLOGICAL.', ';}?>
                                    	<?php if($SEROLOGYCAL){ echo $SEROLOGYCAL.', ';}?>
                                    	<?php if($BIOCHEMICAL){ echo $BIOCHEMICAL.', ';}?>
                                    	<?php if($MICROBIOLOGICAL){ echo $MICROBIOLOGICAL.', ';}?>
                                    	<?php if($X_RAY){ echo $X_RAY.', ';}?>
                                    	<?php if($ECG){ echo $ECG.', ';}?>
                                    </td>
                ...
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    if($ipd=='ipd')
                    {
                              $male_new=array($ky_mn,$pn_mn,$ba_mn,$sly_mn,$sky_mn,$st_mn,$vi_mn);
                              $male_old=array($ky_mo,$pn_mo,$ba_mo,$sly_mo,$sky_mo,$st_mo,$vi_mo);
                              $female_new=array($ky_fn,$pn_fn,$ba_fn,$sly_fn,$sky_fn,$st_fn,$vi_fn);
                              $female_old=array($ky_fo,$pn_fo,$ba_fo,$sly_fo,$sky_fo,$st_fo,$vi_fo);
                              $total=array($ky_tt,$pn_tt,$ba_tt,$sly_tt,$sky_tt,$st_tt,$vi_tt);
                              }
                              else
                              {
                    ...
                    <tbody>
                        <tr>                
                           ...
                           <!--  <td><?php echo $a=$at_tt + $at_ttdn - $at_ttan; ?></td>-->
                             ...
                             <td><?php echo $v= $vi_tt + $vi_ttdn - $vi_ttan; ?></td> 
                             <td><?php echo $t_t= $k + $p + $b + $sl + $sk + $s + $v; ?></td> 
                        </tr>
                        <tr>                
                           ...
                           <!-- <td><?php echo $at_ttdn; ?></td> -->
                             ...
                             <td><?php echo $vi_ttdn; ?></td>
                             <td><?php echo  $t_d=$ky_ttdn + $pn_ttdn + $ba_ttdn + $sly_ttdn + $sky_ttdn + $st_ttdn + $vi_ttdn;?></td> 
                        </tr>
                        <tr>                
                             <td>TOTAL</td> 
                        ...
                        <tr>                
                          ...
                          <!-- <td><?php echo $at_ttan; ?></td>   -->
                             ...
                             <td><?php echo $vi_ttan; ?></td> 
                             <td><?php echo  $t_a=$ky_ttan + $pn_ttan + $ba_ttan + $sly_ttan + $sky_ttan + $st_ttan + $vi_ttan;  ?></td> 
                        </tr>
                        <tr>                
                          ...
                          <!--<td><?php echo ($a + $at_ttan) - $at_ttdn; ?></td> -->
                             ...
                             <td><?php echo ($v + $vi_ttan) - $vi_ttdn; ?></td>
