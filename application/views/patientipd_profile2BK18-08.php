                                ...
                                <tbody>
                                    ...
                                    <?php if($result1){?>
                                            ...
                                            <?php foreach($result1 as $r1 => $rs1){?>
                                                    ...
                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td style="border-right: 2px solid #574646;border-top: 1px solid #574646;">
                                                                                ...
                                                                                ?>
                                                                                <b>
                                                                               <?php if($profile->department_id != 32){ ?> BP : <?php if($result2->bp) { echo $result2->bp."   mm of Hg";}else{ echo $profile->bp;}?><br><?php } ?>
                                                                        ...
                                                                        <?php if($result2->Post_Operative) {?>
                                                                            <tr style="page-break-after: always;">
                                                                                ...
                                                                                <td style="border-right: 2px solid #574646;">
                                                                                    ...
                                                                                    $ex=explode("/",$str);
                                                                                    ?>
                                                                                    <?php if($result2->department_id != 32){ ?><b> BP : <?php if((empty($result2->bp))) {   echo "200/110 mm of Hg"; }  else if($result2->bp) { if($ex[0]%2==0){ echo ($ex[0] + 2).'/'.($ex[1] + 2)."   mm of Hg";} else{ echo $result2->bp,"   mm of Hg";}} ?><br><?php } ?>
                                                    ...
                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td style="border-right: 2px solid #574646;border-top: 1px solid #574646;">
                                                                                ...
                                                                                उर (RS): <?php if($result3->rs) { echo $result3->rs;}?><br>  
                                                    ...
                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td style="border-right: 2px solid #574646;border-top: 1px solid #574646;">
                                                                                ...
                                                                                <b> O/E-  </b><br>
                                                                                <?php if(!empty($profile->tapman)){ echo $profile->tapman; }else { $rand=rand(101,104);echo 'Temp :'.$rand.'ºF<br>'; } ?>                                                                    <?php $str = $bp;
                                                                                $ex=explode("/",$str);
                                                                                ?>
                                                                                <b>
                                                                                ...
                                                                                उर (RS): <?php if($profile->rs) { echo $profile->rs; }else {  echo "अविशेष"; }?><br>
                                                    ...
                                                    <?php 
                                                            if($rs1->ipd_round_date <= $profile->discharge_date || $profile->discharge_date=='0000-00-00'){
                                                                if($result2){
                                                                    $count = $count + 1;
                                                                        ...
                                                                        <tr style="page-break-after: always;">
                                                                            ...
                                                                            <td style="border-right: 2px solid #574646;">
                                                                                <?php 
                                                                                    ...
                                                                                    if($result2->Post_Operative) { echo "=>".$ex_str_p_o[0];echo "<br>"; if($ex_str_p_o[1]) { echo "=>".$ex_str_p_o[1].'<br>'; } if($ex_str_p_o[2]) { echo "=>".$ex_str_p_o[2].'<br>'; } if($ex_str_p_o[3]) { echo "=>".$ex_str_p_o[3].'<br>'; } if($ex_str_p_o[4]) { echo "=>".$ex_str_p_o[4].'<br>'; }
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-right: 2px solid #574646;border-top: 1px solid #574646;"> 
                                            ...
                                            <?php if($profile->department_id != 32){ ?>BP : <?php if($tretment_manual->bp) { echo $tretment_manual->bp."   mm of Hg";}  else { if((!empty($tretment->bp)) && ($i==0)) {   echo "210/120 mm of Hg"; }  else if($bp) { if($ex[0]%2==0){ echo ($ex[0] + 4).'/'.($ex[1] + 4)."   mm of Hg";} else{ echo $bp,"   mm of Hg";}} else { echo $bp[$bp1],"   mm of Hg";} }?><br><?php } ?>
                ...
                <div class="row" style="page-break-after: always;border: groove;">
                    ...
                    <div class="col-md-12 col-lg-12 "> 
                        <div class="container" style="width: 100%; padding-right: 0px;padding-left: 0px;">
                            ...
                            <?php if($profile->manual_status == 1){ ?>
                                <?php 
                                    $result2= $this->db->where(['patient_id_auto'=>$profile->id, 'rounds'=>'1', 'ipd_round_date'=>$profile->discharge_date])
                                                ->order_by('ipd_round_date', 'ASC')
                                                ->get('manual_treatments')
                                                ->row();
                                ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php 
                                                ...
                                                $ex=explode("/",$str);
                                            ?>
                                            <td>B.P.:&nbsp;&nbsp;&nbsp; &nbsp; <span style="font-weight: bold;"><?php if($result2->bp) { if($ex[0]%2==0){ echo ($ex[0] + 2).'/'.($ex[1] + 2)."   mm of Hg";} else{ echo $profile->bp,"   mm of Hg";}} else { echo $result2->bp,"   mm of Hg";}?>  </span></td>
                                            <td>Pulse:&nbsp;&nbsp;&nbsp; &nbsp;<span style="font-weight: bold;">    <?php if($result2->pulse) { { if($result2->pulse%2==0) { echo ($result2->pulse +2)." /min";} else { echo ($profile->pulse)." /min";} }} else { echo $result2->pulse." /min";} ?>  </span></td>
                                        ...
                                        <tr>
                                            <td colspan="6">Treatment Received : <br><span style="font-weight: bold;">  
                                                ...
                                                <?php                        
                                                    ...
                                                    $ex5=explode(",",$tre_rx5);
                                                ?>
                                                <?php if($result2->RX1) { $ex_x=explode("x",$ex[0]);  echo "<br>=>".$ex_x[0];echo "<br>"; if($ex[1]) { $ex_x1=explode("x",$ex[1]);  echo "=>".$ex_x1[0].'<br>'; } if($ex[2]) { $ex_x2=explode("x",$ex[2]); echo "=>".$ex_x2[0].'<br>'; }}?>
                                                <?php if($result2->RX2) { $ex_x20=explode("x",$ex2[0]);  echo "=>".$ex_x20[0];echo "<br>"; if($ex2[1]) { $ex_x21=explode("x",$ex2[1]);  echo "=>".$ex_x21[0].'<br>'; } if($ex2[2]) { $ex_x22=explode("x",$ex2[2]);  echo "=>".$ex_x22[0].'<br>'; }}?>
                                                <?php if($result2->RX3) { $ex_x30=explode("x",$ex3[0]); echo "=>".$ex_x30[0];echo "<br>"; if($ex3[1]) { $ex_x31=explode("x",$ex3[1]); echo "=>".$ex_x31[0].'<br>'; } if($ex3[2]) { $ex_x32=explode("x",$ex3[2]); echo "=>".$ex_x32[0].'<br>'; }}?>
                                                <?php if($result2->RX4) { $ex_x40=explode("x",$ex4[0]); echo "=>".$ex_x40[0];echo "<br>"; if($ex4[1]) { $ex_x41=explode("x",$ex4[1]); echo "=>".$ex_x41[0].'<br>'; } if($ex4[2]) { $ex_x42=explode("x",$ex4[2]);echo "=>".$ex_x42[0].'<br>'; }}?><br>
                                                <?php if($result2->RX5) { $ex_x50=explode("x",$ex5[0]);  echo "=>".$ex_x50[0];echo "<br>"; if($ex5[1]) { $ex_x51=explode("x",$ex5[1]); echo "=>".$ex_x51[0].'<br>'; } if($ex5[2]) { $ex_x52=explode("x",$ex5[2]); echo "=>".$ex_x52[0].'<br>'; }}?>
