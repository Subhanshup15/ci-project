...
<div class="row">
    ...
    <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('report/female_list_panch')?>">
        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading  row" id="PrintMe">
                ...
                <div class="col-lg-12" style="text-align:center;margin-top: 10px;margin-bottom: 10px;">
                    ...
                    <h2><?php  if($section=='opd'){ echo 'OPD'; }else{ echo 'IPD'; }?> Female Panchkarma Total Patient</h2>
