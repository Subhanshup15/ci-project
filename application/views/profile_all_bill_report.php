...
<div class="row">
    <!--  table area -->
    <div class="col-sm-12">
        <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('patients/get_monthly_bill_report'); ?>">
            ...
            <div class="panel-body">
                ...
                <div class="row" style="">
                    ...
                    <div class="col-sm-12" align="center">
                        ...
                        <strong>Monthly Bill Report</strong>
                        <br><br>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $check_date = date("d-m-Y", strtotime($datefrom . ' + ' . $sr_no . 'day'));?></td>
                                                <?php 
                                                        $opd_tt=0;
                                                        $ipd_tt=0;
                                                        for($i=0; $i<count($patients_opd); $i++){
                                                            if(date("d-m-Y", strtotime($patients_opd[$i]->create_date)) == $check_date){
                                                                $section_tret='opd';
                                                                $len=strlen($patients_opd[$i]->dignosis);
                                                                $dd= substr($patients_opd[$i]->dignosis,$len - 1);
                                                                if($dd=='I'){
                                                                    // echo $dd;
                                                                    $dd1=substr($patients_opd[$i]->dignosis, 0, -1);
                                                                    $p_dignosis = '%'.$dd1.'%';
                                                                    $p_dignosis_name=$dd1;
                                                                }else{
                                                                    //echo $dd;
                                                                    $p_dignosis = '%'.$patients_opd[$i]->dignosis.'%';
                                                                    $p_dignosis_name=$patients_opd[$i]->dignosis;
                                                                }
                                                                $ss=date('Y-m-d',strtotime($dateto));
                                                                $table='treatments1';
                                                                if($patients_opd[$i]->manual_status==0){
                                                                    ...
                                                                    $tretment=$this->db->select("*")
                                                                        ...
                                                                        ->where('patient_id_auto',$patients_opd[$i]->id)
                                                                        ->where('dignosis LIKE',$p_dignosis)
                                                                        ->where('ipd_opd ',$section_tret)
                                                                        ->get()
                                                                        ->row();
                                                ...
                                                ?>
                                            <td><?php echo $grandTotalOPD[$sr_no] = $opd_tt;?></td>
                                            <td><?php echo $grandTotalIPD[$sr_no] = $ipd_tt;?></td>
                                            <th><?php echo $grandTotal[$sr_no] = $opd_tt + $ipd_tt; $opd_tt=0;$ipd_tt=0;?></th>
                                        </tr>
                                    <?php } ?>
                                    <tr>
                                        <th colspan=2>Grand Total</th>
                                        <th><?= array_sum($grandTotalOPD)?></th>
                                        <th><?= array_sum($grandTotalIPD)?></th>
