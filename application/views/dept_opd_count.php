...
<div class="row">
    ...
    <form class="form-inline" id="datefilter" name="datefilter" method="GET" action="<?php echo base_url('report/deptopdcountdate')?>">
        ...
        <div class="panel-heading no-print">
            ...
            <div class="col-sm-8" align="center">  
                   <h3 style="margin-top: 0px; margin-bottom: 0px;"><strong><?php echo $this->session->userdata('title') ?></strong></h3>
                    ...
                    <h5>OPD Total Patient Count By Department</h5> 
              ...
              <div class="col-sm-2"></div>
                <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if (!empty($opdcount)) { ?>
                            <?php $sl = 12141;

?>
                            <?php $i = 0; foreach ($opdcount as $patient) { $i++; ?>
                        ...
                        <?php } ?> 
                            ...
                            <tr>
                                    ...
                                    <td><strong><?php echo $totalopdcount[0]->Total;  ?></strong></td>
                                </tr>
