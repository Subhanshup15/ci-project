...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <form class="form-inline" id="datefilter" name="datefilter" method="GET"
            action="<?php echo base_url('commite_tab/investigation_ipd') ?>">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-10 text-center">
                            ...
                            <h2 class="mt-3"> IPD Investigation Register - ( Patho Investigation )</h2>
                    ...
                    <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 30px;" rowspan='2'><?php echo "HEMATOLOGY" ?></th>
                                <th style="width: 30px;" rowspan='2'><?php echo "SEROLOGY" ?></th>
                                <th style="width: 30px;" rowspan='2'><?php echo "BIOCHEMISTRY" ?></th>
                                <th style="width: 30px;" rowspan='2'><?php echo "MICROBIOLOGY" ?></th>
                            ...
                            <?php if (!empty($patients)) { ?>
                                ...
                                <?php foreach ($patients as $bcm) { ?>
                                    <tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC"; ?>">
                                        ...
                                        <td><?php echo $bcm->hematology; ?></td>
                                        <td><?php echo $bcm->serology; ?></td>
                                        <td><?php echo $bcm->biochemistry; ?></td>
                                        <td><?php echo $bcm->microbiology; ?></td>

                                        <td class="center no-print">
                                            <a href="<?= base_url("patients/ipdprofile/$bcm->id") ?>"
                                                class="btn btn-xs btn-success">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="<?= base_url("patients/edit_ipd/$bcm->id") ?>"
                    ...
                    <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= ++$i ?></td>
                                <td>Patient Count</td>
                                <td><?= $total_records = count($patho_patient); ?></td>
                            </tr>

                        </tbody>

                    </table>
                    <h3>Report wise Count</h3>
                    <?php
                    $patho_patient = $this->db->select("
...
")
                    ...
                    $total_hematology = $patho_patient->hematologyCount;
                    $total_serology = $patho_patient->serologyCount;
                    $total_biochemistry = $patho_patient->biochemistryCount;
                    $total_microbiology = $patho_patient->microbiologyCount;
                    $total_tests_all = $total_hematology + $total_serology + $total_biochemistry + $total_microbiology;
                    ?>
                    ...
                    <table width="100%" id="patientdata" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Hematology Count</td>
                                <td><?= $total_hematology ?></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Serology Count</td>
                                <td><?= $total_serology ?></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>Biochemistry Count</td>
                                <td><?= $total_biochemistry ?></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td>Microbiology Count</td>
                                <td><?= $total_microbiology ?></td>
                            </tr>
                            <tr style="font-weight: bold;">
                                <td colspan="2">Total</td>
                                <td><?= $total_tests_all ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <h3>Patient wise Count</h3>
                    <?php
                    // Function to count non-empty values in a given column
                    function count_tests($db, $column, $datefrom, $dateto)
                    {
                    ...
                    $total_hematology = count_tests($this->db, 'hematology', $datefrom, $dateto);
                    $total_serology = count_tests($this->db, 'serology', $datefrom, $dateto);
                    $total_biochemistry = count_tests($this->db, 'biochemistry', $datefrom, $dateto);
                    $total_microbiology = count_tests($this->db, 'microbiology', $datefrom, $dateto);
       ...
       \
        ...
        function filterPatients() {
            ...
            $('#patientdata tbody tr').each(function () {
                var rowGender = $(this).find('td:eq(5)').text().trim();
