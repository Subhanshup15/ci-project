...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <form class="form-inline" id="datefilter" name="datefilter" method="GET"
            action="<?php echo base_url('commite_tab/xray_ecg_usg_patient_count_ipd') ?>">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-xs-8" align="center">
                            ...
                            <h2 class="mt-3">Month Wise XRAY-ECG-USG Register IPD</h2>
...
")
    ...
    COUNT(*) AS ecgCount
")
                        ->from('ecg_patient_count_ipd') // <-- Your ECG IPD table
                        ->where('ipd_opd', 'ipd')
                        ->where('create_date >=', $datefrom)
                        ->where('create_date <=', $dateto)
                        ->group_by("MONTH(create_date), DATE_FORMAT(create_date, '%b')")
    ...
    COUNT(*) AS usgCount
")
                        ->from('usg_patient_count_ipd') // <-- USG OPD table
                        ->where('ipd_opd', 'ipd')
                        ->where('create_date >=', $datefrom)
                        ->where('create_date <=', $dateto)
                        ->group_by("MONTH(create_date), DATE_FORMAT(create_date, '%b')")
