                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview" <?php echo (($this->uri->segment(2) == "laboratory") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_laboratorist/lab/laboratory/create") ?>">Add Lab Report</a></li>
                                <li><a href="<?php echo base_url("dashboard_laboratorist/lab/laboratory") ?>">Laboratory</a></li>
