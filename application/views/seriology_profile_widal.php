<div class="row">
    ...
    <div class="col-sm-12" id="PrintMe">
        ...
        <div  class="panel panel-default thumbnail" style="border:none;">
            ...
            <?php
                $patient_auto_id = $serology_profile[0]->patient_auto_id;
                
               if($section == 'opd'){
                $this->db->distinct();
                $this->db->select('report_type');
                $this->db->where('patient_auto_id', $patient_auto_id);
                $this->db->where('report_type LIKE', '%WIDAL%');
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row" <?php if($i<($count-1) || $i>0) { echo 'style="page-break-after: always; padding-bottom:10px;" '; } ?>>
                        ...
                        <div class="col-md-12 col-lg-12 " style="border-bottom: 1px solid;margin-bottom: 20px;"> 
                            <div class="row">
                                <div class="col-xs-6"><strong>Patient Name:</strong> <strong><?php
  
  if($section=='opd')
                                    { $table='patient'; }
  else 
  { $table='patient_ipd'; }
				  					$name = $this->db->select('*')->from($table)->where('id',$serology_pro[0]->name)->get()->row();
  									if($name)
                                    {
                                      echo $name->firstname;
                                    }else {
  									echo $serology_pro[0]->name; }
  
  
  
  
  
 // echo $serology_pro[0]->name; ?></strong></div>
                                <div class="col-xs-6"><strong> Date:</strong> <strong><?php echo date('d-m-Y',strtotime($serology_pro[0]->create_date)); ?></strong></div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-xs-6"><strong>Gender: <?php if($serology_profile[0]->sex == 'M'){ echo "Male"; } else{ echo"Female"; }?></strong></div>
                                <div class="col-xs-6"><strong>Age: <?php echo $serology_profile[0]->date_of_birth; ?></strong></div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $pp->wd_20_result; ?></td>
                                        <td><?php echo $pp->wd_40_result; ?></td>
                                        <td><?php echo $pp->wd_80_result; ?></td>
                                      <td><?php echo $pp->wd_160_result; ?></td>
                                      <td><?php echo $pp->wd_320_result; ?></td>
                                    </tr>
                                    <?//php } ?>
                                    <?php } ?>
                                </tbody>
