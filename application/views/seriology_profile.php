<div class="row">
 ...
 ?></strong></div>
                            ...
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-xs-6"><strong>Gender:</strong> <?php if($serology_profile[0]->sex == 'M'){ echo "Male"; } else{ echo"Female"; }?></strong></div>
                                <div class="col-xs-6"><strong>Age:</strong> <?php echo $serology_profile[0]->date_of_birth; ?></strong></div>
                            </div>
                        </div>
