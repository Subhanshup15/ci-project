...
class Patient extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_representative/patient/patient_model'
		));
...
// 			redirect('login'); 
	...
	{  
		...
		$data['content'] = $this->load->view('dashboard_representative/patient/patient',$data,true);
	...
	public function create()
	{
		...
		if ($this->form_validation->run() === true) {
			...
			redirect('dashboard_representative/patient/patient/profile/' . $patient_id);
		

		} else {
			$data['content'] = $this->load->view('dashboard_representative/patient/patient_form',$data,true);
			$this->load->view('dashboard_representative/main_wrapper',$data);
		} 
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_representative/patient/patient_profile',$data,true);
		$this->load->view('dashboard_representative/main_wrapper',$data);
	}
