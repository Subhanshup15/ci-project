...
class Home extends CI_Controller {
...

    {
        ...
        $data['content'] = $this->load->view('dashboard_xray/home/dashboard',$data,true);

        $this->load->view('dashboard_xray/main_wrapper',$data);
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_xray/home/profile', $data, true);
...

    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            redirect('dashboard_xray/home/form/');
            ...
            $data['content'] = $this->load->view('dashboard_xray/home/profile_form',$data,true);
