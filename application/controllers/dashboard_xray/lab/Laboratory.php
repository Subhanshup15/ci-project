...
class Laboratory extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_laboratorist/lab/laboratory_model'
		));
...
// 			redirect('login');
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_laboratorist/lab/laboratory',$data,true);	
	...
	public function create()
	{
		...
		if ($this->form_validation->run() === true) {
			...
			if (empty($postData['id'])) {
				...
				redirect('dashboard_laboratorist/lab/laboratory' . $patient_id);
			} else {
				...
				redirect('dashboard_laboratorist/lab/laboratory'.$postData['id']);
			}

		} else {
		//	$data['department_list'] = $this->department_model->department_list(); 
			$data['content'] = $this->load->view('dashboard_laboratorist/lab/lab_form',$data,true);
			$this->load->view('dashboard_laboratorist/main_wrapper',$data);
		} 
	}
