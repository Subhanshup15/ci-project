...
// 			redirect('login');
	...
	{  
		...
		$data['content'] = $this->load->view('dashboard_receptionist/doctor/doctor',$data,true);
	...
	{ 		 
		...
		$data['content'] = $this->load->view('dashboard_receptionist/doctor/doctor_profile',$data,true);
		$this->load->view('dashboard_receptionist/main_wrapper',$data);
	}
